...
namespace CS2 {
	namespace animlib {
		...
		static_assert(offsetof(CS2::animlib::CNmLayerBlendNode_LayerDefinition_t, m_nRootMotionWeightValueNodeIdx) == 0x6, "m_nRootMotionWeightValueNodeIdx in CNmLayerBlendNode::LayerDefinition_t should be at offset 0x6");
		static_assert(offsetof(CS2::animlib::CNmLayerBlendNode_LayerDefinition_t, m_bIsSynchronized) == 0x8, "m_bIsSynchronized in CNmLayerBlendNode::LayerDefinition_t should be at offset 0x8");
		static_assert(offsetof(CS2::animlib::CNmLayerBlendNode_LayerDefinition_t, m_bIgnoreEvents) == 0x9, "m_bIgnoreEvents in CNmLayerBlendNode::LayerDefinition_t should be at offset 0x9");
