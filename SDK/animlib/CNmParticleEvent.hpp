...
namespace CS2 {
	namespace animlib {
		...
		public:
			...
			bool m_bPlayEndCap; // 0x71 | Schema_Builtin | Size: 0x1
		...
		static_assert(offsetof(CS2::animlib::CNmParticleEvent, m_bDetachFromOwner) == 0x70, "m_bDetachFromOwner in CNmParticleEvent should be at offset 0x70");
		static_assert(offsetof(CS2::animlib::CNmParticleEvent, m_bPlayEndCap) == 0x71, "m_bPlayEndCap in CNmParticleEvent should be at offset 0x71");
		static_assert(sizeof(CS2::animlib::CNmParticleEvent) == 0x78, "CNmParticleEvent size should be 0x78");
	}
}
