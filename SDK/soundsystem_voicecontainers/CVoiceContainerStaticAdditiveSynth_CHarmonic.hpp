...
namespace CS2 {
	namespace soundsystem_voicecontainers {
		...
		static_assert(offsetof(CS2::soundsystem_voicecontainers::CVoiceContainerStaticAdditiveSynth_CHarmonic, m_flCents) == 0x8, "m_flCents in CVoiceContainerStaticAdditiveSynth::CHarmonic should be at offset 0x8");
		static_assert(offsetof(CS2::soundsystem_voicecontainers::CVoiceContainerStaticAdditiveSynth_CHarmonic, m_flPhase) == 0xC, "m_flPhase in CVoiceContainerStaticAdditiveSynth::CHarmonic should be at offset 0xC");
