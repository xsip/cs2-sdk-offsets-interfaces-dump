...
namespace CS2 {
	namespace server {
		...
		public:
			...
			uint32_t m_unTotalRoundDamageDealt; // 0x190 | Schema_Builtin | Size: 0x4
		...
		static_assert(offsetof(CS2::server::CCSPlayerController_ActionTrackingServices, m_unTotalRoundDamageDealt) == 0x190, "m_unTotalRoundDamageDealt in CCSPlayerController_ActionTrackingServices should be at offset 0x190");
