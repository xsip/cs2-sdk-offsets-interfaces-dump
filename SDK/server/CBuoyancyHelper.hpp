...
namespace CS2 {
	namespace server {
		...
		static_assert(offsetof(CS2::server::CBuoyancyHelper, m_flNeutrallyBuoyantLinearDamping) == 0x24, "m_flNeutrallyBuoyantLinearDamping in CBuoyancyHelper should be at offset 0x24");
		static_assert(offsetof(CS2::server::CBuoyancyHelper, m_flNeutrallyBuoyantAngularDamping) == 0x28, "m_flNeutrallyBuoyantAngularDamping in CBuoyancyHelper should be at offset 0x28");
		static_assert(offsetof(CS2::server::CBuoyancyHelper, m_bNeutrallyBuoyant) == 0x2C, "m_bNeutrallyBuoyant in CBuoyancyHelper should be at offset 0x2C");
		static_assert(offsetof(CS2::server::CBuoyancyHelper, m_vecFractionOfWheelSubmergedForWheelFriction) == 0x30, "m_vecFractionOfWheelSubmergedForWheelFriction in CBuoyancyHelper should be at offset 0x30");
		static_assert(offsetof(CS2::server::CBuoyancyHelper, m_vecWheelFrictionScales) == 0x48, "m_vecWheelFrictionScales in CBuoyancyHelper should be at offset 0x48");
