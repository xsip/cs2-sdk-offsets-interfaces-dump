...
namespace CS2 {
	namespace server {
		...
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_nQueuedButtonDownMask) == 0x68, "m_nQueuedButtonDownMask in CPlayer_MovementServices should be at offset 0x68");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_nQueuedButtonChangeMask) == 0x70, "m_nQueuedButtonChangeMask in CPlayer_MovementServices should be at offset 0x70");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_nButtonDoublePressed) == 0x78, "m_nButtonDoublePressed in CPlayer_MovementServices should be at offset 0x78");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_pButtonPressedCmdNumber) == 0x80, "m_pButtonPressedCmdNumber in CPlayer_MovementServices should be at offset 0x80");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_nLastCommandNumberProcessed) == 0x180, "m_nLastCommandNumberProcessed in CPlayer_MovementServices should be at offset 0x180");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_nToggleButtonDownMask) == 0x188, "m_nToggleButtonDownMask in CPlayer_MovementServices should be at offset 0x188");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_flMaxspeed) == 0x198, "m_flMaxspeed in CPlayer_MovementServices should be at offset 0x198");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_arrForceSubtickMoveWhen) == 0x19C, "m_arrForceSubtickMoveWhen in CPlayer_MovementServices should be at offset 0x19C");
		static_assert(offsetof(CS2::server::CPlayer_MovementServices, m_flForwardMove) == 0x1AC, "m_flForwardMove in CPlayer_MovementServices should be at offset 0x1AC");
