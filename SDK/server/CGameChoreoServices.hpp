...
namespace CS2 {
	namespace server {
		...
		public:
			...
			client::IChoreoServices_ScriptState_t m_scriptState; // 0x10 | Schema_DeclaredEnum | Size: 0x4
			client::IChoreoServices_ChoreoState_t m_choreoState; // 0x14 | Schema_DeclaredEnum | Size: 0x4
