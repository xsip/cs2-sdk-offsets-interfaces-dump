...
namespace CS2 {
	namespace server {
		...
		static_assert(offsetof(CS2::server::CDamageRecord, m_iBulletsDamage) == 0x60, "m_iBulletsDamage in CDamageRecord should be at offset 0x60");
		static_assert(offsetof(CS2::server::CDamageRecord, m_iDamage) == 0x64, "m_iDamage in CDamageRecord should be at offset 0x64");
		static_assert(offsetof(CS2::server::CDamageRecord, m_iActualHealthRemoved) == 0x68, "m_iActualHealthRemoved in CDamageRecord should be at offset 0x68");
