...
namespace CS2 {
	namespace modellib {
		...
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_FrameStamp_t, m_bPredicted) == 0x9, "m_bPredicted in SkeletonAnimCapture_t::FrameStamp_t should be at offset 0x9");
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_FrameStamp_t, m_flCurTime) == 0xC, "m_flCurTime in SkeletonAnimCapture_t::FrameStamp_t should be at offset 0xC");
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_FrameStamp_t, m_flRealTime) == 0x10, "m_flRealTime in SkeletonAnimCapture_t::FrameStamp_t should be at offset 0x10");
