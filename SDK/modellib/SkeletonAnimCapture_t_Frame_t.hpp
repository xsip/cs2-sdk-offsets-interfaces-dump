...
namespace CS2 {
	namespace modellib {
		...
		public:
			...
			modellib::SkeletonAnimCapture_t_FrameStamp_t m_Stamp; // 0x4 | Schema_DeclaredClass | Size: 0x1c
		...
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_Frame_t, m_bTeleport) == 0x40, "m_bTeleport in SkeletonAnimCapture_t::Frame_t should be at offset 0x40");
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_Frame_t, m_CompositeBones) == 0x48, "m_CompositeBones in SkeletonAnimCapture_t::Frame_t should be at offset 0x48");
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_Frame_t, m_SimStateBones) == 0x60, "m_SimStateBones in SkeletonAnimCapture_t::Frame_t should be at offset 0x60");
		static_assert(offsetof(CS2::modellib::SkeletonAnimCapture_t_Frame_t, m_FeModelAnims) == 0x78, "m_FeModelAnims in SkeletonAnimCapture_t::Frame_t should be at offset 0x78");
