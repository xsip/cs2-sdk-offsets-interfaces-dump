...
namespace CS2 {
	namespace modellib {
		...
		static_assert(offsetof(CS2::modellib::CSceneObjectData_RTProxyDrawDescriptor_t, m_nVertexAlbedoVB) == 0x139, "m_nVertexAlbedoVB in CSceneObjectData::RTProxyDrawDescriptor_t should be at offset 0x139");
