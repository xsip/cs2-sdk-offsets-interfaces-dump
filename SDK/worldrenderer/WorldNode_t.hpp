...
namespace CS2 {
	namespace worldrenderer {
		...
		public:
			...
			char  m_infoOverlays[0x18]; // 0x18 | Schema_Atomic | Size: 0x18
			// GlobalTypes::CUtlVector< uint16 > m_visClusterMembership; // 0x30 | Schema_Atomic | Size: 0x18
			char  m_visClusterMembership[0x18]; // 0x30 | Schema_Atomic | Size: 0x18
			// GlobalTypes::CUtlVector< worldrenderer::AggregateSceneObject_t > m_aggregateSceneObjects; // 0x48 | Schema_Atomic | Size: 0x18
			char  m_aggregateSceneObjects[0x18]; // 0x48 | Schema_Atomic | Size: 0x18
			// GlobalTypes::CUtlVector< worldrenderer::ClutterSceneObject_t > m_clutterSceneObjects; // 0x60 | Schema_Atomic | Size: 0x18
			char  m_clutterSceneObjects[0x18]; // 0x60 | Schema_Atomic | Size: 0x18
			...
			// GlobalTypes::CUtlVector< uint8 > m_overlayLayerIndices; // 0x120 | Schema_Atomic | Size: 0x18
			char  m_overlayLayerIndices[0x18]; // 0x120 | Schema_Atomic | Size: 0x18
			GlobalTypes::CUtlString m_grassFileName; // 0x138 | Schema_Atomic | Size: 0x8
			worldrenderer::BakedLightingInfo_t m_nodeLightingInfo; // 0x140 | Schema_DeclaredClass | Size: 0x48
			bool m_bHasBakedGeometryFlag; // 0x188 | Schema_Builtin | Size: 0x1
		...
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_infoOverlays) == 0x18, "m_infoOverlays in WorldNode_t should be at offset 0x18");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_visClusterMembership) == 0x30, "m_visClusterMembership in WorldNode_t should be at offset 0x30");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_aggregateSceneObjects) == 0x48, "m_aggregateSceneObjects in WorldNode_t should be at offset 0x48");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_clutterSceneObjects) == 0x60, "m_clutterSceneObjects in WorldNode_t should be at offset 0x60");
		...
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_overlayLayerIndices) == 0x120, "m_overlayLayerIndices in WorldNode_t should be at offset 0x120");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_grassFileName) == 0x138, "m_grassFileName in WorldNode_t should be at offset 0x138");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_nodeLightingInfo) == 0x140, "m_nodeLightingInfo in WorldNode_t should be at offset 0x140");
		static_assert(offsetof(CS2::worldrenderer::WorldNode_t, m_bHasBakedGeometryFlag) == 0x188, "m_bHasBakedGeometryFlag in WorldNode_t should be at offset 0x188");
		static_assert(sizeof(CS2::worldrenderer::WorldNode_t) == 0x190, "WorldNode_t size should be 0x190");
	}
}
