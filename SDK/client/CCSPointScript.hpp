...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CCSPointScript, m_pParent) == 0x118, "m_pParent in CCSPointScript should be at offset 0x118");
		static_assert(sizeof(CS2::client::CCSPointScript) == 0x120, "CCSPointScript size should be 0x120");
	}
}
