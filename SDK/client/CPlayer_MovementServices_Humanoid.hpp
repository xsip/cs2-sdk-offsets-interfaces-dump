...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CPlayer_MovementServices_Humanoid, m_flSurfaceFriction) == 0x254, "m_flSurfaceFriction in CPlayer_MovementServices_Humanoid should be at offset 0x254");
