...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CPlayer_MovementServices, m_vecLastFinishTickViewAngles) == 0x220, "m_vecLastFinishTickViewAngles in CPlayer_MovementServices should be at offset 0x220");
		static_assert(offsetof(CS2::client::CPlayer_MovementServices, m_vecOldViewAngles) == 0x22C, "m_vecOldViewAngles in CPlayer_MovementServices should be at offset 0x22C");
