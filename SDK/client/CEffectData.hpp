...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CEffectData, m_vAngles) == 0x2C, "m_vAngles in CEffectData should be at offset 0x2C");
		static_assert(offsetof(CS2::client::CEffectData, m_hEntity) == 0x38, "m_hEntity in CEffectData should be at offset 0x38");
		static_assert(offsetof(CS2::client::CEffectData, m_hOtherEntity) == 0x3C, "m_hOtherEntity in CEffectData should be at offset 0x3C");
		static_assert(offsetof(CS2::client::CEffectData, m_flScale) == 0x40, "m_flScale in CEffectData should be at offset 0x40");
		static_assert(offsetof(CS2::client::CEffectData, m_flMagnitude) == 0x44, "m_flMagnitude in CEffectData should be at offset 0x44");
		static_assert(offsetof(CS2::client::CEffectData, m_flRadius) == 0x48, "m_flRadius in CEffectData should be at offset 0x48");
		static_assert(offsetof(CS2::client::CEffectData, m_nSurfaceProp) == 0x4C, "m_nSurfaceProp in CEffectData should be at offset 0x4C");
		static_assert(offsetof(CS2::client::CEffectData, m_nEffectIndex) == 0x50, "m_nEffectIndex in CEffectData should be at offset 0x50");
		static_assert(offsetof(CS2::client::CEffectData, m_nDamageType) == 0x58, "m_nDamageType in CEffectData should be at offset 0x58");
		static_assert(offsetof(CS2::client::CEffectData, m_nPenetrate) == 0x5C, "m_nPenetrate in CEffectData should be at offset 0x5C");
		static_assert(offsetof(CS2::client::CEffectData, m_nMaterial) == 0x5E, "m_nMaterial in CEffectData should be at offset 0x5E");
		static_assert(offsetof(CS2::client::CEffectData, m_nHitBox) == 0x60, "m_nHitBox in CEffectData should be at offset 0x60");
		static_assert(offsetof(CS2::client::CEffectData, m_nColor) == 0x62, "m_nColor in CEffectData should be at offset 0x62");
		static_assert(offsetof(CS2::client::CEffectData, m_fFlags) == 0x63, "m_fFlags in CEffectData should be at offset 0x63");
		static_assert(offsetof(CS2::client::CEffectData, m_nAttachmentIndex) == 0x64, "m_nAttachmentIndex in CEffectData should be at offset 0x64");
		static_assert(offsetof(CS2::client::CEffectData, m_nAttachmentName) == 0x68, "m_nAttachmentName in CEffectData should be at offset 0x68");
