...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_szModel_AG2) == 0x448, "m_szModel_AG2 in CCSWeaponBaseVData should be at offset 0x448");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_szAnimSkeleton) == 0x528, "m_szAnimSkeleton in CCSWeaponBaseVData should be at offset 0x528");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_vecMuzzlePos0) == 0x608, "m_vecMuzzlePos0 in CCSWeaponBaseVData should be at offset 0x608");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_vecMuzzlePos1) == 0x614, "m_vecMuzzlePos1 in CCSWeaponBaseVData should be at offset 0x614");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_szTracerParticle) == 0x620, "m_szTracerParticle in CCSWeaponBaseVData should be at offset 0x620");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_GearSlot) == 0x700, "m_GearSlot in CCSWeaponBaseVData should be at offset 0x700");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_GearSlotPosition) == 0x704, "m_GearSlotPosition in CCSWeaponBaseVData should be at offset 0x704");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_DefaultLoadoutSlot) == 0x708, "m_DefaultLoadoutSlot in CCSWeaponBaseVData should be at offset 0x708");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nPrice) == 0x70C, "m_nPrice in CCSWeaponBaseVData should be at offset 0x70C");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nKillAward) == 0x710, "m_nKillAward in CCSWeaponBaseVData should be at offset 0x710");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nPrimaryReserveAmmoMax) == 0x714, "m_nPrimaryReserveAmmoMax in CCSWeaponBaseVData should be at offset 0x714");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nSecondaryReserveAmmoMax) == 0x718, "m_nSecondaryReserveAmmoMax in CCSWeaponBaseVData should be at offset 0x718");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bMeleeWeapon) == 0x71C, "m_bMeleeWeapon in CCSWeaponBaseVData should be at offset 0x71C");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bHasBurstMode) == 0x71D, "m_bHasBurstMode in CCSWeaponBaseVData should be at offset 0x71D");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bIsRevolver) == 0x71E, "m_bIsRevolver in CCSWeaponBaseVData should be at offset 0x71E");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bCannotShootUnderwater) == 0x71F, "m_bCannotShootUnderwater in CCSWeaponBaseVData should be at offset 0x71F");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_szName) == 0x720, "m_szName in CCSWeaponBaseVData should be at offset 0x720");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_eSilencerType) == 0x728, "m_eSilencerType in CCSWeaponBaseVData should be at offset 0x728");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nCrosshairMinDistance) == 0x72C, "m_nCrosshairMinDistance in CCSWeaponBaseVData should be at offset 0x72C");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nCrosshairDeltaDistance) == 0x730, "m_nCrosshairDeltaDistance in CCSWeaponBaseVData should be at offset 0x730");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bIsFullAuto) == 0x734, "m_bIsFullAuto in CCSWeaponBaseVData should be at offset 0x734");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nNumBullets) == 0x738, "m_nNumBullets in CCSWeaponBaseVData should be at offset 0x738");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_bReloadsSingleShells) == 0x73C, "m_bReloadsSingleShells in CCSWeaponBaseVData should be at offset 0x73C");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flCycleTime) == 0x740, "m_flCycleTime in CCSWeaponBaseVData should be at offset 0x740");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flMaxSpeed) == 0x748, "m_flMaxSpeed in CCSWeaponBaseVData should be at offset 0x748");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flSpread) == 0x750, "m_flSpread in CCSWeaponBaseVData should be at offset 0x750");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyCrouch) == 0x758, "m_flInaccuracyCrouch in CCSWeaponBaseVData should be at offset 0x758");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyStand) == 0x760, "m_flInaccuracyStand in CCSWeaponBaseVData should be at offset 0x760");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyJump) == 0x768, "m_flInaccuracyJump in CCSWeaponBaseVData should be at offset 0x768");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyLand) == 0x770, "m_flInaccuracyLand in CCSWeaponBaseVData should be at offset 0x770");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyLadder) == 0x778, "m_flInaccuracyLadder in CCSWeaponBaseVData should be at offset 0x778");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyFire) == 0x780, "m_flInaccuracyFire in CCSWeaponBaseVData should be at offset 0x780");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyMove) == 0x788, "m_flInaccuracyMove in CCSWeaponBaseVData should be at offset 0x788");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flRecoilAngle) == 0x790, "m_flRecoilAngle in CCSWeaponBaseVData should be at offset 0x790");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flRecoilAngleVariance) == 0x798, "m_flRecoilAngleVariance in CCSWeaponBaseVData should be at offset 0x798");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flRecoilMagnitude) == 0x7A0, "m_flRecoilMagnitude in CCSWeaponBaseVData should be at offset 0x7A0");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flRecoilMagnitudeVariance) == 0x7A8, "m_flRecoilMagnitudeVariance in CCSWeaponBaseVData should be at offset 0x7A8");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_nTracerFrequency) == 0x7B0, "m_nTracerFrequency in CCSWeaponBaseVData should be at offset 0x7B0");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyJumpInitial) == 0x7B8, "m_flInaccuracyJumpInitial in CCSWeaponBaseVData should be at offset 0x7B8");
		static_assert(offsetof(CS2::client::CCSWeaponBaseVData, m_flInaccuracyJumpApex) == 0x7BC, "m_flInaccuracyJumpApex in CCSWeaponBaseVData should be at offset 0x7BC");
