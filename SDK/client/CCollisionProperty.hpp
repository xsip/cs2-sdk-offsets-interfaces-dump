...
namespace CS2 {
	namespace client {
		...
		public:
			S2_PAD(0x10);
			client::VPhysicsCollisionAttribute_t m_collisionAttribute; // 0x10 | Schema_DeclaredClass | Size: 0x30
		...
		static_assert(offsetof(CS2::client::CCollisionProperty, m_usSolidFlags) == 0x5A, "m_usSolidFlags in CCollisionProperty should be at offset 0x5A");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_nSolidType) == 0x5B, "m_nSolidType in CCollisionProperty should be at offset 0x5B");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_triggerBloat) == 0x5C, "m_triggerBloat in CCollisionProperty should be at offset 0x5C");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_nSurroundType) == 0x5D, "m_nSurroundType in CCollisionProperty should be at offset 0x5D");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_CollisionGroup) == 0x5E, "m_CollisionGroup in CCollisionProperty should be at offset 0x5E");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_nEnablePhysics) == 0x5F, "m_nEnablePhysics in CCollisionProperty should be at offset 0x5F");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_flBoundingRadius) == 0x60, "m_flBoundingRadius in CCollisionProperty should be at offset 0x60");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_vecSpecifiedSurroundingMins) == 0x64, "m_vecSpecifiedSurroundingMins in CCollisionProperty should be at offset 0x64");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_vecSpecifiedSurroundingMaxs) == 0x70, "m_vecSpecifiedSurroundingMaxs in CCollisionProperty should be at offset 0x70");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_vecSurroundingMaxs) == 0x7C, "m_vecSurroundingMaxs in CCollisionProperty should be at offset 0x7C");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_vecSurroundingMins) == 0x88, "m_vecSurroundingMins in CCollisionProperty should be at offset 0x88");
		static_assert(offsetof(CS2::client::CCollisionProperty, m_vCapsuleCenter1) == 0x94, "m_vCapsuleCenter1 in CCollisionProperty should be at offset 0x94");
