...
namespace CS2 {
	namespace client {
		...
		public:
			S2_PAD(0x8);
			GlobalTypes::CUtlVector<GlobalTypes::CHandle<client::C_BaseEntity>> m_Providers; // 0x8 | Schema_Atomic | Size: 0x18
			...
			GlobalTypes::CUtlVector<client::CAttributeManager::cached_attribute_float_t> m_CachedResults; // 0x30 | Schema_Atomic | Size: 0x18
