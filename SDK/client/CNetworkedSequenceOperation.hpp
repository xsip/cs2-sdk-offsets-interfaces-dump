...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CNetworkedSequenceOperation, m_flWeight) == 0x14, "m_flWeight in CNetworkedSequenceOperation should be at offset 0x14");
		static_assert(offsetof(CS2::client::CNetworkedSequenceOperation, m_bSequenceChangeNetworked) == 0x1C, "m_bSequenceChangeNetworked in CNetworkedSequenceOperation should be at offset 0x1C");
		static_assert(offsetof(CS2::client::CNetworkedSequenceOperation, m_bDiscontinuity) == 0x1D, "m_bDiscontinuity in CNetworkedSequenceOperation should be at offset 0x1D");
