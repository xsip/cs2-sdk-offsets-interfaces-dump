...
namespace CS2 {
	namespace client {
		...
		public:
			...
			S2_PAD(0x3);
			GlobalTypes::CHandle<client::C_BaseEntity> m_hObserverTarget; // 0x4c | Schema_Atomic | Size: 0x4
		...
		static_assert(offsetof(CS2::client::CPlayer_ObserverServices, m_bForcedObserverMode) == 0x54, "m_bForcedObserverMode in CPlayer_ObserverServices should be at offset 0x54");
