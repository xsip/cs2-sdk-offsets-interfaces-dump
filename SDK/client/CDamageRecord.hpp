...
namespace CS2 {
	namespace client {
		...
		static_assert(offsetof(CS2::client::CDamageRecord, m_hPlayerControllerRecipient) == 0x3C, "m_hPlayerControllerRecipient in CDamageRecord should be at offset 0x3C");
		static_assert(offsetof(CS2::client::CDamageRecord, m_szPlayerDamagerName) == 0x40, "m_szPlayerDamagerName in CDamageRecord should be at offset 0x40");
