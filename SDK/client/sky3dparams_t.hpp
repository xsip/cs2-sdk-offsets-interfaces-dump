...
namespace CS2 {
	namespace client {
		...
		public:
			...
			client::fogparams_t fog; // 0x20 | Schema_DeclaredClass | Size: 0x68
		...
		static_assert(offsetof(CS2::client::sky3dparams_t, flClip3DSkyBoxNearToWorldFarOffset) == 0x1C, "flClip3DSkyBoxNearToWorldFarOffset in sky3dparams_t should be at offset 0x1C");
