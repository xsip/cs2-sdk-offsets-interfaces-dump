...
namespace CS2 {
	namespace particles {
		...
		static_assert(offsetof(CS2::particles::C_OP_RemapSpeed, m_flOutputMin) == 0x1DC, "m_flOutputMin in C_OP_RemapSpeed should be at offset 0x1DC");
		static_assert(offsetof(CS2::particles::C_OP_RemapSpeed, m_flOutputMax) == 0x1E0, "m_flOutputMax in C_OP_RemapSpeed should be at offset 0x1E0");
