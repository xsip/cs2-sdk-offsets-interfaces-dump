...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			int32_t m_nInputMin; // 0x1d4 | Schema_Builtin | Size: 0x4
			int32_t m_nInputMax; // 0x1d8 | Schema_Builtin | Size: 0x4
			float32 m_flOutputMin; // 0x1dc | Schema_Builtin | Size: 0x4
			float32 m_flOutputMax; // 0x1e0 | Schema_Builtin | Size: 0x4
			bool m_bBackwards; // 0x1e4 | Schema_Builtin | Size: 0x1
			S2_PAD(0x3);
		...
		static_assert(offsetof(CS2::particles::C_OP_RemapParticleCountOnScalarEndCap, m_flOutputMin) == 0x1DC, "m_flOutputMin in C_OP_RemapParticleCountOnScalarEndCap should be at offset 0x1DC");
		static_assert(offsetof(CS2::particles::C_OP_RemapParticleCountOnScalarEndCap, m_flOutputMax) == 0x1E0, "m_flOutputMax in C_OP_RemapParticleCountOnScalarEndCap should be at offset 0x1E0");
