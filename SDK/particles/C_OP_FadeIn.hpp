...
namespace CS2 {
	namespace particles {
		...
		public:
			float32 m_flFadeInTimeMin; // 0x1d0 | Schema_Builtin | Size: 0x4
			float32 m_flFadeInTimeMax; // 0x1d4 | Schema_Builtin | Size: 0x4
			float32 m_flFadeInTimeExp; // 0x1d8 | Schema_Builtin | Size: 0x4
