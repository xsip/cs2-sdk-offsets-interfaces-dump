...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			int32_t m_nFlowCP; // 0x1e0 | Schema_Builtin | Size: 0x4
			int32_t m_nActiveCP; // 0x1e4 | Schema_Builtin | Size: 0x4
			int32_t m_nActiveCPField; // 0x1e8 | Schema_Builtin | Size: 0x4
			S2_PAD(0x4);
			particleslib::CParticleCollectionFloatInput m_flRetestRate; // 0x1f0 | Schema_DeclaredClass | Size: 0x170
		...
		static_assert(offsetof(CS2::particles::C_OP_SetControlPointToWaterSurface, m_nActiveCP) == 0x1E4, "m_nActiveCP in C_OP_SetControlPointToWaterSurface should be at offset 0x1E4");
		static_assert(offsetof(CS2::particles::C_OP_SetControlPointToWaterSurface, m_nActiveCPField) == 0x1E8, "m_nActiveCPField in C_OP_SetControlPointToWaterSurface should be at offset 0x1E8");
