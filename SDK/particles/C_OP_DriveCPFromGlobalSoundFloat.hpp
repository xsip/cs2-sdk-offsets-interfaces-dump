...
namespace CS2 {
	namespace particles {
		...
		public:
			int32_t m_nOutputControlPoint; // 0x1d8 | Schema_Builtin | Size: 0x4
			int32_t m_nOutputField; // 0x1dc | Schema_Builtin | Size: 0x4
			...
			GlobalTypes::CUtlString m_StackName; // 0x1f0 | Schema_Atomic | Size: 0x8
			GlobalTypes::CUtlString m_OperatorName; // 0x1f8 | Schema_Atomic | Size: 0x8
		...
		static_assert(offsetof(CS2::particles::C_OP_DriveCPFromGlobalSoundFloat, m_flInputMax) == 0x1E4, "m_flInputMax in C_OP_DriveCPFromGlobalSoundFloat should be at offset 0x1E4");
		static_assert(offsetof(CS2::particles::C_OP_DriveCPFromGlobalSoundFloat, m_flOutputMin) == 0x1E8, "m_flOutputMin in C_OP_DriveCPFromGlobalSoundFloat should be at offset 0x1E8");
		static_assert(offsetof(CS2::particles::C_OP_DriveCPFromGlobalSoundFloat, m_flOutputMax) == 0x1EC, "m_flOutputMax in C_OP_DriveCPFromGlobalSoundFloat should be at offset 0x1EC");
		static_assert(offsetof(CS2::particles::C_OP_DriveCPFromGlobalSoundFloat, m_StackName) == 0x1F0, "m_StackName in C_OP_DriveCPFromGlobalSoundFloat should be at offset 0x1F0");
