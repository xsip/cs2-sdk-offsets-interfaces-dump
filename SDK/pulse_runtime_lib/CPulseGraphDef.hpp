...
namespace CS2 {
	namespace pulse_runtime_lib {
		...
		public:
			...
			// server::CUtlVector<pulse_runtime_lib::CPulseCell_Base*> m_Cells; // 0x68 | Schema_Atomic | Size: 0x18
			...
			// server::CUtlVector<pulse_runtime_lib::CPulse_InvokeBinding*> m_InvokeBindings; // 0xb0 | Schema_Atomic | Size: 0x18
			char m_InvokeBindings[0x18]; // 0xb0 | Schema_Atomic | Size: 0x18
			// server::CUtlVector<pulse_runtime_lib::CPulse_CallInfo*> m_CallInfos; // 0xc8 | Schema_Atomic | Size: 0x18
			...
			// server::CUtlVector<pulse_runtime_lib::CPulse_BlackboardReference> m_BlackboardReferences; // 0x110 | Schema_Atomic | Size: 0x18
