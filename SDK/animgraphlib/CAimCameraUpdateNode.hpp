...
namespace CS2 {
	namespace animgraphlib {
		...
		public:
			...
			animgraphlib::CAnimParamHandle m_hParameterPelvisOffset; // 0x74 | Schema_DeclaredClass | Size: 0x2
			animgraphlib::CAnimParamHandle m_hParameterCameraOnly; // 0x76 | Schema_DeclaredClass | Size: 0x2
			animgraphlib::CAnimParamHandle m_hParameterWeaponDepenetrationDistance; // 0x78 | Schema_DeclaredClass | Size: 0x2
			animgraphlib::CAnimParamHandle m_hParameterWeaponDepenetrationDelta; // 0x7a | Schema_DeclaredClass | Size: 0x2
			animgraphlib::CAnimParamHandle m_hParameterCameraClearanceDistance; // 0x7c | Schema_DeclaredClass | Size: 0x2
			S2_PAD(0x2);
		...
		static_assert(offsetof(CS2::animgraphlib::CAimCameraUpdateNode, m_hParameterCameraOnly) == 0x76, "m_hParameterCameraOnly in CAimCameraUpdateNode should be at offset 0x76");
		static_assert(offsetof(CS2::animgraphlib::CAimCameraUpdateNode, m_hParameterWeaponDepenetrationDistance) == 0x78, "m_hParameterWeaponDepenetrationDistance in CAimCameraUpdateNode should be at offset 0x78");
		static_assert(offsetof(CS2::animgraphlib::CAimCameraUpdateNode, m_hParameterWeaponDepenetrationDelta) == 0x7A, "m_hParameterWeaponDepenetrationDelta in CAimCameraUpdateNode should be at offset 0x7A");
