...
namespace CS2 {
	namespace particleslib {
		enum ParticleFloatType_t : std::uint32_t {
			...
			ParticleFloatType_t_PF_TYPE_COUNT = 0x1b,
			...
			ParticleFloatType_t_PF_TYPE_PARTICLE_SCREENSPACE_CAMERA_DISTANCE = 0x19,
			ParticleFloatType_t_PF_TYPE_PARTICLE_SCREENSPACE_CAMERA_DOT_PRODUCT = 0x1a,
