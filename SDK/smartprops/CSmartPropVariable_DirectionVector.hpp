...
namespace CS2 {
	namespace smartprops {
		...
		public:
			smartprops::SmartPropDirection_t m_DefaultValue; // 0x38 | Schema_DeclaredEnum | Size: 0x4
			S2_PAD(0x4); // End padding
		};
		static_assert(offsetof(CS2::smartprops::CSmartPropVariable_DirectionVector, m_DefaultValue) == 0x38, "m_DefaultValue in CSmartPropVariable_DirectionVector should be at offset 0x38");
