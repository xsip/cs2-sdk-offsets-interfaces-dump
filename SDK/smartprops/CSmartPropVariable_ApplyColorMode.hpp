...
namespace CS2 {
	namespace smartprops {
		...
		static_assert(offsetof(CS2::smartprops::CSmartPropVariable_ApplyColorMode, m_DefaultValue) == 0x38, "m_DefaultValue in CSmartPropVariable_ApplyColorMode should be at offset 0x38");
