	...
	namespace SchemaOffsets {
		namespace modellib {
			...
			namespace VPhysXJoint_t /**/ {
				...
				constexpr std::ptrdiff_t m_Frame1 = 0x10; // GlobalTypes::CTransform m_Frame1; |  Schema_Atomic | Size: 0x20
				constexpr std::ptrdiff_t m_Frame2 = 0x30; // GlobalTypes::CTransform m_Frame2; |  Schema_Atomic | Size: 0x20
				...
				constexpr std::ptrdiff_t m_LinearLimit = 0x54; // modellib::VPhysXRange_t m_LinearLimit; |  Schema_DeclaredClass | Size: 0x8
				constexpr std::ptrdiff_t m_bEnableLinearMotor = 0x5c; // bool m_bEnableLinearMotor; |  0x5c | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_vLinearTargetVelocity = 0x60; // GlobalTypes::Vector m_vLinearTargetVelocity; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_SwingLimit = 0x74; // modellib::VPhysXRange_t m_SwingLimit; |  Schema_DeclaredClass | Size: 0x8
				constexpr std::ptrdiff_t m_bEnableTwistLimit = 0x7c; // bool m_bEnableTwistLimit; |  0x7c | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_TwistLimit = 0x80; // modellib::VPhysXRange_t m_TwistLimit; |  Schema_DeclaredClass | Size: 0x8
				constexpr std::ptrdiff_t m_bEnableAngularMotor = 0x88; // bool m_bEnableAngularMotor; |  0x88 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_vAngularTargetVelocity = 0x8c; // GlobalTypes::Vector m_vAngularTargetVelocity; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_Tag = 0xc0; // GlobalTypes::CUtlString m_Tag; |  Schema_Atomic | Size: 0x8
			}
		}
	}
}
