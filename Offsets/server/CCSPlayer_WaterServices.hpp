	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSPlayer_WaterServices /*: public CS2::server::CPlayer_WaterServices*/ {
				constexpr std::ptrdiff_t m_NextDrownDamageTime = 0x40; // entity2::GameTime_t m_NextDrownDamageTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_nDrownDmgRate = 0x44; // int32_t m_nDrownDmgRate; |  0x44 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_AirFinishedTime = 0x48; // entity2::GameTime_t m_AirFinishedTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flWaterJumpTime = 0x4c; // float32 m_flWaterJumpTime; |  0x4c | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_vecWaterJumpVel = 0x50; // GlobalTypes::Vector m_vecWaterJumpVel; |  Schema_Atomic | Size: 0xc
