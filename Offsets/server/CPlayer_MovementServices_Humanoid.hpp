	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CPlayer_MovementServices_Humanoid /*: public CS2::server::CPlayer_MovementServices*/ {
				...
				constexpr std::ptrdiff_t m_flCrouchTransitionStartTime = 0x248; // entity2::GameTime_t m_flCrouchTransitionStartTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_groundNormal = 0x250; // GlobalTypes::Vector m_groundNormal; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_flSurfaceFriction = 0x25c; // float32 m_flSurfaceFriction; |  0x25c | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_surfaceProps = 0x260; // GlobalTypes::CUtlStringToken m_surfaceProps; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_nStepside = 0x270; // int32_t m_nStepside; |  0x270 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_vecSmoothedVelocity = 0x274; // GlobalTypes::Vector m_vecSmoothedVelocity; |  Schema_Atomic | Size: 0xc
			}
		}
	}
}
