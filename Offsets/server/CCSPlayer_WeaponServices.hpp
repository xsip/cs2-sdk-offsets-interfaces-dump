	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSPlayer_WeaponServices /*: public CS2::server::CPlayer_WeaponServices*/ {
				...
				constexpr std::ptrdiff_t m_networkAnimTiming = 0x1a40; // GlobalTypes::CNetworkUtlVectorBase< uint8 > m_networkAnimTiming; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bBlockInspectUntilNextGraphUpdate = 0x1a58; // bool m_bBlockInspectUntilNextGraphUpdate; |  0x1a58 | Schema_Builtin | Size: 0x1
			}
		}
	}
}
