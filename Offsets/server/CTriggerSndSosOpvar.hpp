	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CTriggerSndSosOpvar /*: public CS2::server::CBaseTrigger*/ {
				constexpr std::ptrdiff_t m_hTouchingPlayers = 0x9a8; // server::CUtlVector< server.dll::CHandle< CBaseEntity > > m_hTouchingPlayers; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_flPosition = 0x9c0; // GlobalTypes::Vector m_flPosition; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_opvarName = 0x9d8; // GlobalTypes::CUtlSymbolLarge m_opvarName; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_stackName = 0x9e0; // GlobalTypes::CUtlSymbolLarge m_stackName; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_operatorName = 0x9e8; // GlobalTypes::CUtlSymbolLarge m_operatorName; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_VecNormPos = 0xcf4; // GlobalTypes::Vector m_VecNormPos; |  Schema_Atomic | Size: 0xc
