	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSPlayerPawn /*: public CS2::server::CCSPlayerPawnBase*/ {
				constexpr std::ptrdiff_t m_pBulletServices = 0xec8; // server::CCSPlayer_BulletServices* m_pBulletServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pHostageServices = 0xed0; // server::CCSPlayer_HostageServices* m_pHostageServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pBuyServices = 0xed8; // server::CCSPlayer_BuyServices* m_pBuyServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pActionTrackingServices = 0xee0; // server::CCSPlayer_ActionTrackingServices* m_pActionTrackingServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pRadioServices = 0xee8; // server::CCSPlayer_RadioServices* m_pRadioServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pDamageReactServices = 0xef0; // server::CCSPlayer_DamageReactServices* m_pDamageReactServices; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_nCharacterDefIndex = 0xef8; // uint16_t m_nCharacterDefIndex; |  0xef8 | Schema_Builtin | Size: 0x2
				constexpr std::ptrdiff_t m_bHasFemaleVoice = 0xefa; // bool m_bHasFemaleVoice; |  0xefa | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_strVOPrefix = 0xf00; // GlobalTypes::CUtlString m_strVOPrefix; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_szLastPlaceName = 0xf08; // char m_szLastPlaceName[18]; |  0xf08 | Schema_FixedArray | Size: 0x12
				constexpr std::ptrdiff_t m_bInHostageResetZone = 0xfc8; // bool m_bInHostageResetZone; |  0xfc8 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bInBuyZone = 0xfc9; // bool m_bInBuyZone; |  0xfc9 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_TouchingBuyZones = 0xfd0; // server::CUtlVector< server.dll::CHandle< CBaseEntity > > m_TouchingBuyZones; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bWasInBuyZone = 0xfe8; // bool m_bWasInBuyZone; |  0xfe8 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bInHostageRescueZone = 0xfe9; // bool m_bInHostageRescueZone; |  0xfe9 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bInBombZone = 0xfea; // bool m_bInBombZone; |  0xfea | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bWasInHostageRescueZone = 0xfeb; // bool m_bWasInHostageRescueZone; |  0xfeb | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_iRetakesOffering = 0xfec; // int32_t m_iRetakesOffering; |  0xfec | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0xff0; // int32_t m_iRetakesOfferingCard; |  0xff0 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0xff4; // bool m_bRetakesHasDefuseKit; |  0xff4 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0xff5; // bool m_bRetakesMVPLastRound; |  0xff5 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0xff8; // int32_t m_iRetakesMVPBoostItem; |  0xff8 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0xffc; // client::loadout_slot_t m_RetakesMVPBoostExtraUtility; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x1000; // entity2::GameTime_t m_flHealthShotBoostExpirationTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flLandingTimeSeconds = 0x1004; // float32 m_flLandingTimeSeconds; |  0x1004 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_aimPunchAngle = 0x1008; // GlobalTypes::QAngle m_aimPunchAngle; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1014; // GlobalTypes::QAngle m_aimPunchAngleVel; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1020; // int32_t m_aimPunchTickBase; |  0x1020 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1024; // float32 m_aimPunchTickFraction; |  0x1024 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_aimPunchCache = 0x1028; // GlobalTypes::CUtlVector< GlobalTypes::QAngle > m_aimPunchCache; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x1040; // bool m_bIsBuyMenuOpen; |  0x1040 | Schema_Builtin | Size: 0x1
