	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CScriptedSequence /*: public CS2::server::CBaseEntity*/ {
				constexpr std::ptrdiff_t m_iszEntry = 0x4f0; // GlobalTypes::CUtlSymbolLarge m_iszEntry; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszPreIdle = 0x4f8; // GlobalTypes::CUtlSymbolLarge m_iszPreIdle; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszPlay = 0x500; // GlobalTypes::CUtlSymbolLarge m_iszPlay; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszPostIdle = 0x508; // GlobalTypes::CUtlSymbolLarge m_iszPostIdle; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszModifierToAddOnPlay = 0x510; // GlobalTypes::CUtlSymbolLarge m_iszModifierToAddOnPlay; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszNextScript = 0x518; // GlobalTypes::CUtlSymbolLarge m_iszNextScript; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszEntity = 0x520; // GlobalTypes::CUtlSymbolLarge m_iszEntity; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_iszSyncGroup = 0x528; // GlobalTypes::CUtlSymbolLarge m_iszSyncGroup; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_nMoveTo = 0x530; // modellib::ScriptedMoveTo_t m_nMoveTo; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_nMoveToGait = 0x534; // modellib::SharedMovementGait_t m_nMoveToGait; |  Schema_DeclaredEnum | Size: 0x1
				constexpr std::ptrdiff_t m_nHeldWeaponBehavior = 0x538; // modellib::ScriptedHeldWeaponBehavior_t m_nHeldWeaponBehavior; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_nForcedCrouchState = 0x53c; // client::ForcedCrouchState_t m_nForcedCrouchState; |  Schema_DeclaredEnum | Size: 0x4
				...
				constexpr std::ptrdiff_t m_startTime = 0x57c; // entity2::GameTime_t m_startTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_hTargetEnt = 0x594; // server::CHandle< server::CBaseEntity > m_hTargetEnt; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hNextCine = 0x598; // server::CHandle< server::CScriptedSequence > m_hNextCine; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_hForcedTarget = 0x5a0; // server::CHandle< server::CBaseAnimGraph > m_hForcedTarget; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_onDeathBehavior = 0x5a8; // client::ScriptedOnDeath_t m_onDeathBehavior; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_ConflictResponse = 0x5ac; // server::ScriptedConflictResponse_t m_ConflictResponse; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_OnBeginSequence = 0x5b0; // entity2::CEntityIOOutput m_OnBeginSequence; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnActionStartOrLoop = 0x5d8; // entity2::CEntityIOOutput m_OnActionStartOrLoop; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnEndSequence = 0x600; // entity2::CEntityIOOutput m_OnEndSequence; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnPostIdleEndSequence = 0x628; // entity2::CEntityIOOutput m_OnPostIdleEndSequence; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnCancelSequence = 0x650; // entity2::CEntityIOOutput m_OnCancelSequence; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnCancelFailedSequence = 0x678; // entity2::CEntityIOOutput m_OnCancelFailedSequence; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnScriptEvent = 0x6a0; // entity2::CEntityIOOutput m_OnScriptEvent[8]; |  Schema_FixedArray | Size: 0xa00
				constexpr std::ptrdiff_t m_matOtherToMain = 0x7e0; // GlobalTypes::CTransform m_matOtherToMain; |  Schema_Atomic | Size: 0x20
				constexpr std::ptrdiff_t m_hInteractionMainEntity = 0x800; // server::CHandle< server::CBaseEntity > m_hInteractionMainEntity; |  Schema_Atomic | Size: 0x4
