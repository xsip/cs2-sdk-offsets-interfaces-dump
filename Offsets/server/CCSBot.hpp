	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSBot /*: public CS2::server::CBot*/ {
				...
				constexpr std::ptrdiff_t m_rogueTimer = 0x160; // server::CountdownTimer m_rogueTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_surpriseTimer = 0x190; // server::CountdownTimer m_surpriseTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_leader = 0x1ac; // server::CHandle< server::CCSPlayerPawn > m_leader; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_hurryTimer = 0x1b8; // server::CountdownTimer m_hurryTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_alertTimer = 0x1d0; // server::CountdownTimer m_alertTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_sneakTimer = 0x1e8; // server::CountdownTimer m_sneakTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_panicTimer = 0x200; // server::CountdownTimer m_panicTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_stillTimer = 0x508; // server::IntervalTimer m_stillTimer; |  Schema_DeclaredClass | Size: 0x10
				...
				constexpr std::ptrdiff_t m_areaEnteredTimestamp = 0x5e1c; // entity2::GameTime_t m_areaEnteredTimestamp; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_repathTimer = 0x5e20; // server::CountdownTimer m_repathTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_avoidFriendTimer = 0x5e38; // server::CountdownTimer m_avoidFriendTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_isFriendInTheWay = 0x5e50; // bool m_isFriendInTheWay; |  0x5e50 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_politeTimer = 0x5e58; // server::CountdownTimer m_politeTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_mustRunTimer = 0x5ee8; // server::CountdownTimer m_mustRunTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_waitTimer = 0x5f00; // server::CountdownTimer m_waitTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_updateTravelDistanceTimer = 0x5f18; // server::CountdownTimer m_updateTravelDistanceTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_inhibitWaitingForHostageTimer = 0x61d8; // server::CountdownTimer m_inhibitWaitingForHostageTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_waitForHostageTimer = 0x61f0; // server::CountdownTimer m_waitForHostageTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_noisePosition = 0x6208; // GlobalTypes::Vector m_noisePosition; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_noiseSource = 0x6220; // server::CCSPlayerPawn* m_noiseSource; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_noiseBendTimer = 0x6238; // server::CountdownTimer m_noiseBendTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_bentNoisePosition = 0x6250; // GlobalTypes::Vector m_bentNoisePosition; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_lookAtSpot = 0x6274; // GlobalTypes::Vector m_lookAtSpot; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_approachPointViewPosition = 0x642c; // GlobalTypes::Vector m_approachPointViewPosition; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_viewSteadyTimer = 0x6438; // server::IntervalTimer m_viewSteadyTimer; |  Schema_DeclaredClass | Size: 0x10
				constexpr std::ptrdiff_t m_tossGrenadeTimer = 0x6450; // server::CountdownTimer m_tossGrenadeTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_isAvoidingGrenade = 0x6470; // server::CountdownTimer m_isAvoidingGrenade; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_targetSpot = 0x68ac; // GlobalTypes::Vector m_targetSpot; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_targetSpotVelocity = 0x68b8; // GlobalTypes::Vector m_targetSpotVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_targetSpotPredicted = 0x68c4; // GlobalTypes::Vector m_targetSpotPredicted; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimError = 0x68d0; // GlobalTypes::QAngle m_aimError; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimGoal = 0x68dc; // GlobalTypes::QAngle m_aimGoal; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_targetSpotTime = 0x68e8; // entity2::GameTime_t m_targetSpotTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_aimFocusNextUpdate = 0x68f4; // entity2::GameTime_t m_aimFocusNextUpdate; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_ignoreEnemiesTimer = 0x6900; // server::CountdownTimer m_ignoreEnemiesTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_enemy = 0x6918; // server::CHandle< server::CCSPlayerPawn > m_enemy; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_lastEnemyPosition = 0x6920; // GlobalTypes::Vector m_lastEnemyPosition; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_bomber = 0x6b50; // server::CHandle< server::CCSPlayerPawn > m_bomber; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_nearbyFriendCount = 0x6b54; // int32_t m_nearbyFriendCount; |  0x6b54 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_closestVisibleFriend = 0x6b58; // server::CHandle< server::CCSPlayerPawn > m_closestVisibleFriend; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_closestVisibleHumanFriend = 0x6b5c; // server::CHandle< server::CCSPlayerPawn > m_closestVisibleHumanFriend; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_attentionInterval = 0x6b60; // server::IntervalTimer m_attentionInterval; |  Schema_DeclaredClass | Size: 0x10
				constexpr std::ptrdiff_t m_attacker = 0x6b70; // server::CHandle< server::CCSPlayerPawn > m_attacker; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_attackedTimestamp = 0x6b74; // float32 m_attackedTimestamp; |  0x6b74 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_burnedByFlamesTimer = 0x6b78; // server::IntervalTimer m_burnedByFlamesTimer; |  Schema_DeclaredClass | Size: 0x10
				...
				constexpr std::ptrdiff_t m_equipTimer = 0x6b90; // server::IntervalTimer m_equipTimer; |  Schema_DeclaredClass | Size: 0x10
				constexpr std::ptrdiff_t m_zoomTimer = 0x6ba0; // server::CountdownTimer m_zoomTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_fireWeaponTimestamp = 0x6bb8; // entity2::GameTime_t m_fireWeaponTimestamp; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_lookForWeaponsOnGroundTimer = 0x6bc0; // server::CountdownTimer m_lookForWeaponsOnGroundTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_sawEnemySniperTimer = 0x6be0; // server::CountdownTimer m_sawEnemySniperTimer; |  Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_stuckTimestamp = 0x6c9c; // entity2::GameTime_t m_stuckTimestamp; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_stuckSpot = 0x6ca0; // GlobalTypes::Vector m_stuckSpot; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_wiggleTimer = 0x6cb0; // server::CountdownTimer m_wiggleTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_stuckJumpTimer = 0x6cc8; // server::CountdownTimer m_stuckJumpTimer; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_nextCleanupCheckTimestamp = 0x6ce0; // entity2::GameTime_t m_nextCleanupCheckTimestamp; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_lastOrigin = 0x6d14; // GlobalTypes::Vector m_lastOrigin; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_radioSubject = 0x6d2c; // server::CHandle< server::CCSPlayerPawn > m_radioSubject; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_radioPosition = 0x6d30; // GlobalTypes::Vector m_radioPosition; |  Schema_Atomic | Size: 0xc
