	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSWeaponBase /*: public CS2::server::CBasePlayerWeapon*/ {
				...
				constexpr std::ptrdiff_t m_iWeaponGameplayAnimState = 0xeb2; // client::WeaponGameplayAnimState m_iWeaponGameplayAnimState; |  Schema_DeclaredEnum | Size: 0x2
				constexpr std::ptrdiff_t m_flWeaponGameplayAnimStateTimestamp = 0xeb4; // entity2::GameTime_t m_flWeaponGameplayAnimStateTimestamp; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flInspectCancelCompleteTime = 0xeb8; // entity2::GameTime_t m_flInspectCancelCompleteTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_OnPlayerPickup = 0xf10; // entity2::CEntityIOOutput m_OnPlayerPickup; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_weaponMode = 0xf38; // client::CSWeaponMode m_weaponMode; |  Schema_DeclaredEnum | Size: 0x4
				...
				constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0xf40; // GlobalTypes::Vector m_vecTurningInaccuracyEyeDirLast; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0xf54; // entity2::GameTime_t m_flLastAccuracyUpdateTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0xf68; // entity2::GameTick_t m_nPostponeFireReadyTicks; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flDroppedAtTime = 0xf74; // entity2::GameTime_t m_flDroppedAtTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0xf7c; // entity2::GameTime_t m_flTimeSilencerSwitchComplete; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nextOwnerTouchTime = 0xfa4; // entity2::GameTime_t m_nextOwnerTouchTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_nextPrevOwnerTouchTime = 0xfa8; // entity2::GameTime_t m_nextPrevOwnerTouchTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_nextPrevOwnerUseTime = 0xfb0; // entity2::GameTime_t m_nextPrevOwnerUseTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_hPrevOwner = 0xfb4; // server::CHandle< server::CCSPlayerPawn > m_hPrevOwner; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_nDropTick = 0xfb8; // entity2::GameTick_t m_nDropTick; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_fLastShotTime = 0xfe0; // entity2::GameTime_t m_fLastShotTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_IronSightController = 0xff0; // server::CIronSightController m_IronSightController; |  Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_iIronSightMode = 0x1008; // int32_t m_iIronSightMode; |  0x1008 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x100c; // entity2::GameTime_t m_flLastLOSTraceFailureTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flWatTickOffset = 0x1010; // float32 m_flWatTickOffset; |  0x1010 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_flLastShakeTime = 0x1020; // entity2::GameTime_t m_flLastShakeTime; |  Schema_DeclaredClass | Size: 0x4
			}
		}
	}
}
