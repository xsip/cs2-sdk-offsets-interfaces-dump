	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSPlayerController_InventoryServices /*: public CS2::client::CPlayerControllerComponent*/ {
				...
				constexpr std::ptrdiff_t m_vecServerAuthoritativeWeaponSlots = 0xf50; // GlobalTypes::CUtlVectorEmbeddedNetworkVar< client::ServerAuthoritativeWeaponSlot_t > m_vecServerAuthoritativeWeaponSlots; |  Schema_Atomic | Size: 0x88
				constexpr std::ptrdiff_t m_vecNetworkableLoadout = 0xfd8; // server::CUtlVectorEmbeddedNetworkVar< server::CSNetworkableLoadout_t > m_vecNetworkableLoadout; |  Schema_Atomic | Size: 0x88
			}
		}
	}
}
