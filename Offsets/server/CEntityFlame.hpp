	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CEntityFlame /*: public CS2::server::CBaseEntity*/ {
				constexpr std::ptrdiff_t m_hEntAttached = 0x4f0; // server::CHandle< server::CBaseEntity > m_hEntAttached; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flLifetime = 0x508; // entity2::GameTime_t m_flLifetime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_hAttacker = 0x50c; // server::CHandle< server::CBaseEntity > m_hAttacker; |  Schema_Atomic | Size: 0x4
