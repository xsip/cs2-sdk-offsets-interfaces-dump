	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CBasePlayerWeapon /*: public CS2::server::CEconEntity*/ {
				constexpr std::ptrdiff_t m_nNextPrimaryAttackTick = 0xe50; // entity2::GameTick_t m_nNextPrimaryAttackTick; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nNextSecondaryAttackTick = 0xe58; // entity2::GameTick_t m_nNextSecondaryAttackTick; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_OnPlayerUse = 0xe70; // entity2::CEntityIOOutput m_OnPlayerUse; |  Schema_DeclaredClass | Size: 0x28
			}
		}
	}
}
