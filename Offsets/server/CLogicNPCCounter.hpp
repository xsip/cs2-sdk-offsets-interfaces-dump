	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CLogicNPCCounter /*: public CS2::server::CBaseEntity*/ {
				constexpr std::ptrdiff_t m_OnMinCountAll = 0x4f0; // entity2::CEntityIOOutput m_OnMinCountAll; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnMaxCountAll = 0x518; // entity2::CEntityIOOutput m_OnMaxCountAll; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnFactorAll = 0x540; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnFactorAll; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinPlayerDistAll = 0x568; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnMinPlayerDistAll; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinCount_1 = 0x590; // entity2::CEntityIOOutput m_OnMinCount_1; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnMaxCount_1 = 0x5b8; // entity2::CEntityIOOutput m_OnMaxCount_1; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnFactor_1 = 0x5e0; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnFactor_1; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinPlayerDist_1 = 0x608; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnMinPlayerDist_1; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinCount_2 = 0x630; // entity2::CEntityIOOutput m_OnMinCount_2; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnMaxCount_2 = 0x658; // entity2::CEntityIOOutput m_OnMaxCount_2; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnFactor_2 = 0x680; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnFactor_2; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinPlayerDist_2 = 0x6a8; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnMinPlayerDist_2; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinCount_3 = 0x6d0; // entity2::CEntityIOOutput m_OnMinCount_3; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnMaxCount_3 = 0x6f8; // entity2::CEntityIOOutput m_OnMaxCount_3; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_OnFactor_3 = 0x720; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnFactor_3; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_OnMinPlayerDist_3 = 0x748; // GlobalTypes::CEntityOutputTemplate< float32 > m_OnMinPlayerDist_3; |  Schema_Atomic | Size: 0x28
				constexpr std::ptrdiff_t m_hSource = 0x770; // GlobalTypes::CEntityHandle m_hSource; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_iszSourceEntityName = 0x778; // GlobalTypes::CUtlSymbolLarge m_iszSourceEntityName; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_iszNPCClassname_1 = 0x7a0; // GlobalTypes::CUtlSymbolLarge m_iszNPCClassname_1; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_iszNPCClassname_2 = 0x7c8; // GlobalTypes::CUtlSymbolLarge m_iszNPCClassname_2; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_iszNPCClassname_3 = 0x7f0; // GlobalTypes::CUtlSymbolLarge m_iszNPCClassname_3; |  Schema_Atomic | Size: 0x8
