	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CBasePlayerController /*: public CS2::server::CBaseEntity*/ {
				...
				constexpr std::ptrdiff_t m_hPawn = 0x528; // server::CHandle< server::CBasePlayerPawn > m_hPawn; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_bKnownTeamMismatch = 0x52c; // bool m_bKnownTeamMismatch; |  0x52c | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_nSplitScreenSlot = 0x530; // GlobalTypes::CSplitScreenSlot m_nSplitScreenSlot; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hSplitOwner = 0x534; // server::CHandle< server::CBasePlayerController > m_hSplitOwner; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hSplitScreenPlayers = 0x538; // server::CUtlVector< server.dll::CHandle< CBasePlayerController > > m_hSplitScreenPlayers; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bIsHLTV = 0x550; // bool m_bIsHLTV; |  0x550 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_iConnected = 0x554; // client::PlayerConnectedState m_iConnected; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_iszPlayerName = 0x558; // char m_iszPlayerName[128]; |  0x558 | Schema_FixedArray | Size: 0x80
				constexpr std::ptrdiff_t m_szNetworkIDString = 0x5d8; // GlobalTypes::CUtlString m_szNetworkIDString; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_iIgnoreGlobalChat = 0x728; // client::ChatIgnoreType_t m_iIgnoreGlobalChat; |  Schema_DeclaredEnum | Size: 0x4
