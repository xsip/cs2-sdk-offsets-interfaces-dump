	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CPointTeleport /*: public CS2::server::CServerOnlyPointEntity*/ {
				constexpr std::ptrdiff_t m_vSaveOrigin = 0x4f0; // GlobalTypes::Vector m_vSaveOrigin; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vSaveAngles = 0x4fc; // GlobalTypes::QAngle m_vSaveAngles; |  Schema_Atomic | Size: 0xc
