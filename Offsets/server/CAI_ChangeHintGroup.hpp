	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CAI_ChangeHintGroup /*: public CS2::server::CBaseEntity*/ {
				...
				constexpr std::ptrdiff_t m_strSearchName = 0x4f8; // GlobalTypes::CUtlSymbolLarge m_strSearchName; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_strNewHintGroup = 0x500; // GlobalTypes::CUtlSymbolLarge m_strNewHintGroup; |  Schema_Atomic | Size: 0x8
