	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CSoundOpvarSetOBBWindEntity /*: public CS2::server::CSoundOpvarSetPointBase*/ {
				constexpr std::ptrdiff_t m_vMins = 0x598; // GlobalTypes::Vector m_vMins; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vMaxs = 0x5a4; // GlobalTypes::Vector m_vMaxs; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vDistanceMins = 0x5b0; // GlobalTypes::Vector m_vDistanceMins; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vDistanceMaxs = 0x5bc; // GlobalTypes::Vector m_vDistanceMaxs; |  Schema_Atomic | Size: 0xc
