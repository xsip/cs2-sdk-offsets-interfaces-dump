	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CDamageRecord /**/ {
				constexpr std::ptrdiff_t m_PlayerDamager = 0x30; // server::CHandle< server::CCSPlayerPawn > m_PlayerDamager; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_PlayerRecipient = 0x34; // server::CHandle< server::CCSPlayerPawn > m_PlayerRecipient; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hPlayerControllerDamager = 0x38; // server::CHandle< server::CCSPlayerController > m_hPlayerControllerDamager; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hPlayerControllerRecipient = 0x3c; // server::CHandle< server::CCSPlayerController > m_hPlayerControllerRecipient; |  Schema_Atomic | Size: 0x4
