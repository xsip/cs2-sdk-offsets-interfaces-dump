	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_RemapSpeed /*: public CS2::particles::CParticleFunctionOperator*/ {
				...
				constexpr std::ptrdiff_t m_nSetMethod = 0x1d4; // particles::ParticleSetMethod_t m_nSetMethod; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_bIgnoreDelta = 0x1d8; // bool m_bIgnoreDelta; |  0x1d8 | Schema_Builtin | Size: 0x1
			}
		}
	}
}
