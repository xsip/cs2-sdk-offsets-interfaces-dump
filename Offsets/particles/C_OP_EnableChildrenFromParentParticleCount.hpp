	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_EnableChildrenFromParentParticleCount /*: public CS2::particles::CParticleFunctionPreEmission*/ {
				...
				constexpr std::ptrdiff_t m_nNumChildrenToEnable = 0x1e0; // particleslib::CParticleCollectionFloatInput m_nNumChildrenToEnable; |  Schema_DeclaredClass | Size: 0x170
