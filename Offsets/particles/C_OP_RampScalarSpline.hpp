	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_RampScalarSpline /*: public CS2::particles::CParticleFunctionOperator*/ {
				...
				constexpr std::ptrdiff_t m_flBias = 0x1d8; // float32 m_flBias; |  0x1d8 | Schema_Builtin | Size: 0x4
				...
				constexpr std::ptrdiff_t m_bEaseOut = 0x205; // bool m_bEaseOut; |  0x205 | Schema_Builtin | Size: 0x1
			}
		}
	}
}
