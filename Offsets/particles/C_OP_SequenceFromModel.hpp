	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_OP_SequenceFromModel /*: public CS2::particles::CParticleFunctionOperator*/ {
				...
				constexpr std::ptrdiff_t m_nFieldOutputAnim = 0x1d8; // particles::ParticleAttributeIndex_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nSetMethod = 0x1ec; // particles::ParticleSetMethod_t  | Schema_DeclaredEnum | Size: 0x4
			}
		}
	}
}
