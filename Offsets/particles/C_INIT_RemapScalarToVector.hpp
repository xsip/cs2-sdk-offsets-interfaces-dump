	...
	namespace SchemaOffsets {
		namespace particles {
			...
			namespace C_INIT_RemapScalarToVector /*: public CS2::particles::CParticleFunctionInitializer*/ {
				...
				constexpr std::ptrdiff_t m_vecOutputMin = 0x1e8; // GlobalTypes::Vector m_vecOutputMin; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecOutputMax = 0x1f4; // GlobalTypes::Vector m_vecOutputMax; |  Schema_Atomic | Size: 0xc
