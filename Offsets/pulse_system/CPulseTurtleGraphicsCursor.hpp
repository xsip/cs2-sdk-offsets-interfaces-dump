	...
	namespace SchemaOffsets {
		namespace pulse_system {
			...
			namespace CPulseTurtleGraphicsCursor /*: public CS2::pulse_runtime_lib::CPulseExecCursor*/ {
				constexpr std::ptrdiff_t m_Color = 0xd0; // GlobalTypes::Color m_Color; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_vPos = 0xd4; // GlobalTypes::Vector2D m_vPos; |  Schema_Atomic | Size: 0x8
