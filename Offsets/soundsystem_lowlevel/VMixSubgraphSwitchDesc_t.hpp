	...
	namespace SchemaOffsets {
		namespace soundsystem_lowlevel {
			...
			namespace VMixSubgraphSwitchDesc_t /**/ {
				constexpr std::ptrdiff_t m_interpolationMode = 0x0; // soundsystem_lowlevel::VMixSubgraphSwitchInterpolationType_t m_interpolationMode; |  Schema_DeclaredEnum | Size: 0x4
