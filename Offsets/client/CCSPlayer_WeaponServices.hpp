	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CCSPlayer_WeaponServices /*: public CS2::client::CPlayer_WeaponServices*/ {
				...
				constexpr std::ptrdiff_t m_nOldTotalInputHistoryCount = 0x4e8; // uint32_t m_nOldTotalInputHistoryCount; |  0x4e8 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_networkAnimTiming = 0x1a48; // GlobalTypes::C_NetworkUtlVectorBase< uint8 > m_networkAnimTiming; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bBlockInspectUntilNextGraphUpdate = 0x1a60; // bool m_bBlockInspectUntilNextGraphUpdate; |  0x1a60 | Schema_Builtin | Size: 0x1
			}
		}
	}
}
