	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CTakeDamageResult /**/ {
				constexpr std::ptrdiff_t m_pOriginatingInfo = 0x0; // GlobalTypes::CTakeDamageInfo* m_pOriginatingInfo; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_nHealthLost = 0x8; // int32_t m_nHealthLost; |  0x8 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_nDamageTaken = 0xc; // int32_t m_nDamageTaken; |  0xc | Schema_Builtin | Size: 0x4
