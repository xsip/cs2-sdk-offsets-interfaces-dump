	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_BaseEntity /*: public CS2::entity2::CEntityInstance*/ {
				constexpr std::ptrdiff_t m_CBodyComponent = 0x38; // client::CBodyComponent* m_CBodyComponent; |  Schema_Ptr | Size: 0x8
				...
				constexpr std::ptrdiff_t m_nLastThinkTick = 0x328; // entity2::GameTick_t m_nLastThinkTick; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_pGameSceneNode = 0x330; // client::CGameSceneNode* m_pGameSceneNode; |  Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pRenderComponent = 0x338; // client::CRenderComponent* m_pRenderComponent; |  Schema_Ptr | Size: 0x8
				...
				constexpr std::ptrdiff_t m_hSceneObjectController = 0x364; // client::CHandle< client::C_BaseEntity > m_hSceneObjectController; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_tokLayerMatchID = 0x37c; // GlobalTypes::CUtlStringToken m_tokLayerMatchID; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_nSubclassID = 0x380; // GlobalTypes::CUtlStringToken m_nSubclassID; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_aThinkFunctions = 0x398; // GlobalTypes::CUtlVector< client::thinkfunc_t > m_aThinkFunctions; |  Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_flCreateTime = 0x3e0; // entity2::GameTime_t m_flCreateTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nNextThinkTick = 0x3f0; // entity2::GameTick_t m_nNextThinkTick; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_fFlags = 0x3f8; // uint32_t m_fFlags; |  0x3f8 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_vecAbsVelocity = 0x3fc; // GlobalTypes::Vector m_vecAbsVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecServerVelocity = 0x408; // client::CNetworkVelocityVector m_vecServerVelocity; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_vecVelocity = 0x430; // client::CNetworkVelocityVector m_vecVelocity; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_vecBaseVelocity = 0x510; // GlobalTypes::Vector m_vecBaseVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_hEffectEntity = 0x51c; // client::CHandle< client::C_BaseEntity > m_hEffectEntity; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hOwnerEntity = 0x520; // client::CHandle< client::C_BaseEntity > m_hOwnerEntity; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_MoveCollide = 0x524; // client::MoveCollide_t m_MoveCollide; |  Schema_DeclaredEnum | Size: 0x1
				constexpr std::ptrdiff_t m_MoveType = 0x525; // client::MoveType_t m_MoveType; |  Schema_DeclaredEnum | Size: 0x1
				constexpr std::ptrdiff_t m_nActualMoveType = 0x526; // client::MoveType_t m_nActualMoveType; |  Schema_DeclaredEnum | Size: 0x1
				...
				constexpr std::ptrdiff_t m_hGroundEntity = 0x530; // client::CHandle< client::C_BaseEntity > m_hGroundEntity; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flNavIgnoreUntilTime = 0x54c; // entity2::GameTime_t m_flNavIgnoreUntilTime; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_hOldMoveParent = 0x574; // client::CHandle< client::C_BaseEntity > m_hOldMoveParent; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_Particles = 0x578; // particleslib::CParticleProperty m_Particles; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_vecAngVelocity = 0x5a8; // GlobalTypes::QAngle m_vecAngVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_DataChangeEventRef = 0x5b4; // int32_t m_DataChangeEventRef; |  0x5b4 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_dependencies = 0x5b8; // GlobalTypes::CUtlVector< GlobalTypes::CEntityHandle > m_dependencies; |  Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_sUniqueHammerID = 0x5e8; // GlobalTypes::CUtlString m_sUniqueHammerID; |  Schema_Atomic | Size: 0x8
				constexpr std::ptrdiff_t m_nBloodType = 0x5f0; // client::BloodType m_nBloodType; |  Schema_DeclaredEnum | Size: 0x4
			}
		}
	}
}
