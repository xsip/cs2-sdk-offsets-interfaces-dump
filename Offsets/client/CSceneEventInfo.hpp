	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CSceneEventInfo /**/ {
				...
				constexpr std::ptrdiff_t m_flNext = 0x18; // entity2::GameTime_t m_flNext; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_hTarget = 0x44; // client::CHandle< client::C_BaseEntity > m_hTarget; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_nSceneEventId = 0x48; // client::SceneEventId_t m_nSceneEventId; |  Schema_DeclaredClass | Size: 0x4
