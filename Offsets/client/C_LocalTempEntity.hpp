	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_LocalTempEntity /*: public CS2::client::CBaseAnimGraph*/ {
				...
				constexpr std::ptrdiff_t die = 0x115c; // entity2::GameTime_t die; |  Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t tentOffset = 0x117c; // GlobalTypes::Vector tentOffset; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecTempEntAngVelocity = 0x1188; // GlobalTypes::QAngle m_vecTempEntAngVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t tempent_renderamt = 0x1194; // int32_t tempent_renderamt; |  0x1194 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_vecNormal = 0x1198; // GlobalTypes::Vector m_vecNormal; |  Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_vLastCollisionOrigin = 0x11d0; // GlobalTypes::Vector m_vLastCollisionOrigin; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecTempEntVelocity = 0x11dc; // GlobalTypes::Vector m_vecTempEntVelocity; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecPrevAbsOrigin = 0x11e8; // GlobalTypes::Vector m_vecPrevAbsOrigin; |  Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecTempEntAcceleration = 0x11f4; // GlobalTypes::Vector m_vecTempEntAcceleration; |  Schema_Atomic | Size: 0xc
			}
		}
	}
}
