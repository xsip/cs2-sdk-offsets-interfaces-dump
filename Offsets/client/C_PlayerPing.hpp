	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_PlayerPing /*: public CS2::client::C_BaseEntity*/ {
				constexpr std::ptrdiff_t m_hPlayer = 0x628; // client::CHandle< client::C_CSPlayerPawn > m_hPlayer; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hPingedEntity = 0x62c; // client::CHandle< client::C_BaseEntity > m_hPingedEntity; |  Schema_Atomic | Size: 0x4
