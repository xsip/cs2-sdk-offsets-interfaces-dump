	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CRR_Response /**/ {
				...
				constexpr std::ptrdiff_t m_Params = 0x160; // client::ResponseParams m_Params; |  Schema_DeclaredClass | Size: 0x20
				...
				constexpr std::ptrdiff_t m_Followup = 0x198; // client::ResponseFollowup m_Followup; |  Schema_DeclaredClass | Size: 0x31
				constexpr std::ptrdiff_t m_recipientFilter = 0x1ca; // GlobalTypes::CUtlSymbol m_recipientFilter; |  Schema_Atomic | Size: 0x2
			}
		}
	}
}
