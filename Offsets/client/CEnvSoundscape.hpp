	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CEnvSoundscape /*: public CS2::client::C_BaseEntity*/ {
				constexpr std::ptrdiff_t m_OnPlay = 0x5f8; // entity2::CEntityIOOutput m_OnPlay; |  Schema_DeclaredClass | Size: 0x28
				constexpr std::ptrdiff_t m_flRadius = 0x620; // float32 m_flRadius; |  0x620 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_soundEventName = 0x628; // GlobalTypes::CUtlSymbolLarge m_soundEventName; |  Schema_Atomic | Size: 0x8
				...
				constexpr std::ptrdiff_t m_positionNames = 0x640; // GlobalTypes::CUtlSymbolLarge m_positionNames[8]; |  Schema_FixedArray | Size: 0x40
				constexpr std::ptrdiff_t m_hProxySoundscape = 0x680; // client::CHandle< client::CEnvSoundscape > m_hProxySoundscape; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_bDisabled = 0x684; // bool m_bDisabled; |  0x684 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_soundscapeName = 0x688; // GlobalTypes::CUtlSymbolLarge m_soundscapeName; |  Schema_Atomic | Size: 0x8
