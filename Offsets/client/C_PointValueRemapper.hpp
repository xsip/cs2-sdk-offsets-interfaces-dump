	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_PointValueRemapper /*: public CS2::client::C_BaseEntity*/ {
				...
				constexpr std::ptrdiff_t m_nInputType = 0x5fc; // client::ValueRemapperInputType_t m_nInputType; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_hRemapLineStart = 0x600; // client::CHandle< client::C_BaseEntity > m_hRemapLineStart; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_hRemapLineEnd = 0x604; // client::CHandle< client::C_BaseEntity > m_hRemapLineEnd; |  Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nOutputType = 0x618; // client::ValueRemapperOutputType_t m_nOutputType; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_hOutputEntities = 0x620; // client::C_NetworkUtlVectorBase< client.dll::CHandle< C_BaseEntity > > m_hOutputEntities; |  Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_nHapticsType = 0x638; // client::ValueRemapperHapticsType_t m_nHapticsType; |  Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_nMomentumType = 0x63c; // client::ValueRemapperMomentumType_t m_nMomentumType; |  Schema_DeclaredEnum | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nRatchetType = 0x64c; // client::ValueRemapperRatchetType_t m_nRatchetType; |  Schema_DeclaredEnum | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flPreviousUpdateTickTime = 0x660; // entity2::GameTime_t m_flPreviousUpdateTickTime; |  Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_vecPreviousTestPoint = 0x664; // GlobalTypes::Vector m_vecPreviousTestPoint; |  Schema_Atomic | Size: 0xc
			}
		}
	}
}
