	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CDestructiblePartsSystemComponent /**/ {
				...
				constexpr std::ptrdiff_t m_DamageLevelTakenByHitGroup = 0x48; // GlobalTypes::C_NetworkUtlVectorBase< uint16 > m_DamageLevelTakenByHitGroup; |  Schema_Atomic | Size: 0x18
