	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CPlayer_ObserverServices /*: public CS2::client::CPlayerPawnComponent*/ {
				...
				constexpr std::ptrdiff_t m_hObserverTarget = 0x44; // client::CHandle< client::C_BaseEntity > m_hObserverTarget; |  Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_iObserverLastMode = 0x48; // client::ObserverMode_t m_iObserverLastMode; |  Schema_DeclaredEnum | Size: 0x4
				...
				constexpr std::ptrdiff_t m_flObserverChaseDistanceCalcTime = 0x54; // entity2::GameTime_t m_flObserverChaseDistanceCalcTime; |  Schema_DeclaredClass | Size: 0x4
			}
		}
	}
}
