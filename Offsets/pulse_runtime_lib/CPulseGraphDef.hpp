	...
	namespace SchemaOffsets {
		namespace pulse_runtime_lib {
			...
			namespace CPulseGraphDef /**/ {
				...
				constexpr std::ptrdiff_t m_Cells = 0x68; // GlobalTypes::CUtlVector<pulse_runtime_lib::CPulseCell_Base*>  | Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_InvokeBindings = 0xb0; // GlobalTypes::CUtlVector<pulse_runtime_lib::CPulse_InvokeBinding*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_CallInfos = 0xc8; // GlobalTypes::CUtlVector<pulse_runtime_lib::CPulse_CallInfo*>  | Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_BlackboardReferences = 0x110; // GlobalTypes::CUtlVector<pulse_runtime_lib::CPulse_BlackboardReference>  | Schema_Atomic | Size: 0x18
