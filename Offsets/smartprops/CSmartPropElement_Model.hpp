	...
	namespace SchemaOffsets {
		namespace smartprops {
			...
			namespace CSmartPropElement_Model /*: public CS2::smartprops::CSmartPropElement*/ {
				...
				constexpr std::ptrdiff_t m_bRigidDeformation = 0x188; // GlobalTypes::CSmartPropAttributeBool m_bRigidDeformation; |  Schema_Atomic | Size: 0x40
				constexpr std::ptrdiff_t m_flUniformModelScale = 0x1c8; // GlobalTypes::CSmartPropAttributeFloat m_flUniformModelScale; |  Schema_Atomic | Size: 0x40
				constexpr std::ptrdiff_t m_nLodLevel = 0x208; // GlobalTypes::CSmartPropAttributeInt m_nLodLevel; |  Schema_Atomic | Size: 0x40
