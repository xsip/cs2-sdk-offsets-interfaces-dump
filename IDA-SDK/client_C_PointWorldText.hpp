...
class client_C_PointWorldText {
    ...
    Color m_Color;
    client_PointWorldTextJustifyHorizontal_t m_nJustifyHorizontal;
    client_PointWorldTextJustifyVertical_t m_nJustifyVertical;
    client_PointWorldTextReorientMode_t m_nReorientMode;
};
