...
class server_CEnvEntityMaker {
    ...
    char m_hCurrentInstance[0x4];
    char m_hCurrentBlocker[0x4];
    ...
    entity2_CEntityIOOutput m_pOutputOnSpawned;
    entity2_CEntityIOOutput m_pOutputOnFailedSpawn;
};
