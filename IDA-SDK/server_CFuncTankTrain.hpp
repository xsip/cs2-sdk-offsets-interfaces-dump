...
class server_CFuncTankTrain {
    ...
    entity2_GameTime_t m_flNextMoveSoundTime;
    float32 m_flMoveSoundMinPitch;
    float32 m_flMoveSoundMaxPitch;
    server_TrainOrientationType_t m_eOrientationType;
    server_TrainVelocityType_t m_eVelocityType;
    char pad_3755[0x14];
    entity2_CEntityIOOutput m_OnStart;
    entity2_CEntityIOOutput m_OnNext;
    entity2_CEntityIOOutput m_OnArrivedAtDestinationNode;
    bool m_bManualSpeedChanges;
    char pad_3756[0x3];
    float32 m_flDesiredSpeed;
    entity2_GameTime_t m_flSpeedChangeTime;
    float32 m_flAccelSpeed;
    float32 m_flDecelSpeed;
    bool m_bAccelToSpeed;
    char pad_3757[0x3];
    entity2_GameTime_t m_flNextMPSoundTime;
    char end_pad_3758[0x4];
    entity2_CEntityIOOutput m_OnDeath;
};
