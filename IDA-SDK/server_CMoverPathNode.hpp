...
class server_CMoverPathNode {
    ...
    entity2_CEntityIOOutput m_OnStartFromOrInSegment;
    entity2_CEntityIOOutput m_OnStoppedAtOrInSegment;
    entity2_CEntityIOOutput m_OnPassThrough;
    entity2_CEntityIOOutput m_OnPassThroughForward;
    entity2_CEntityIOOutput m_OnPassThroughReverse;
    char m_hMover[0x4];
    char pad_3806[0xc];
