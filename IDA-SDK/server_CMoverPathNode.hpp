...
class server_CMoverPathNode {
    ...
    char m_hPath[0x4];
    char end_pad_3939[0xc];
    char m_OnStartFromOrInSegment[0x20];
    char m_OnStoppedAtOrInSegment[0x20];
    char m_OnPassThrough[0x20];
    char m_OnPassThroughForward[0x20];
    char m_OnPassThroughReverse[0x20];
};
