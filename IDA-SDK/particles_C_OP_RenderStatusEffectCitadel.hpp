...
class particles_C_OP_RenderStatusEffectCitadel {
    char vTable1798[0x8];
    ...
    char m_pTextureNormal[0x8];
    char m_pTextureMetalness[0x8];
    char m_pTextureRoughness[0x8];
    char m_pTextureSelfIllum[0x8];
    char m_pTextureDetail[0x8];
};
