...
class server_CLogicBranchList {
    ...
    char m_LogicBranchList[0x18];
    server_LogicBranchListenerLastState_t m_eLastState;
    char pad_3755[0x4];
    entity2_CEntityIOOutput m_OnAllTrue;
    entity2_CEntityIOOutput m_OnAllFalse;
    entity2_CEntityIOOutput m_OnMixed;
};
