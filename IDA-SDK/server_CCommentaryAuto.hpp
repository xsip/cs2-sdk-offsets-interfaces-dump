...
class server_CCommentaryAuto {
    ...
    entity2_CEntityIOOutput m_OnCommentaryNewGame;
    entity2_CEntityIOOutput m_OnCommentaryMidGame;
    entity2_CEntityIOOutput m_OnCommentaryMultiplayerSpawn;
};
