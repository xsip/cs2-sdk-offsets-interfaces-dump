...
class particles_C_OP_RenderSound {
    char vTable1797[0x8];
    ...
    particles_ParticleAttributeIndex_t m_nSndLvlField;
    particles_ParticleAttributeIndex_t m_nDurationField;
    particles_ParticleAttributeIndex_t m_nPitchField;
    particles_ParticleAttributeIndex_t m_nVolumeField;
    int32_t m_nChannel;
    int32_t m_nCPReference;
    char m_pszSoundName[256];
    bool m_bSuppressStopSoundEvent;
    char end_pad_2248[0x7];
};
