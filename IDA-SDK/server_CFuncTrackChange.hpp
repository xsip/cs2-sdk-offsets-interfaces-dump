...
class server_CFuncTrackChange {
    ...
    float32 m_flTWidth;
    float32 m_flTLength;
    char end_pad_3072[0x4];
    CUtlSymbolLarge m_sNoise;
    QAngle m_end;
    QAngle m_start;
    server_CPathTrack* m_trackTop;
    server_CPathTrack* m_trackBottom;
    server_CFuncTrackTrain* m_train;
    CUtlSymbolLarge m_trackTopName;
    CUtlSymbolLarge m_trackBottomName;
    CUtlSymbolLarge m_trainName;
    server_TRAIN_CODE m_code;
    int32_t m_targetState;
    int32_t m_use;
    char end_pad_3760[0x4];
};
