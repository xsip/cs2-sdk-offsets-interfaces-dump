...
class C_CSPlayerPawn {
    ...
    char pad_624[0x2];
    WaterWakeMode_t m_nWaterWakeMode;
    float32 m_flWaterWorldZ;
    float32 m_flWaterNextTraceTime;
    char end_pad_625[0x60];
    ...
    char end_pad_633[0x7];
    char _vtable_pad_728[0x10];
    ...
    char pad_773[0x84];
    GameTime_t m_arrOldEyeAnglesTimes[4];
