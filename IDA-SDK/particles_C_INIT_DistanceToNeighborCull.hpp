...
class particles_C_INIT_DistanceToNeighborCull {
    char vTable1798[0x8];
    ...
    particleslib_CPerParticleFloatInput m_flDistance;
    bool m_bIncludeRadii;
    char pad_1893[0x7];
    particleslib_CPerParticleFloatInput m_flLifespanOverlap;
    particles_ParticleAttributeIndex_t m_nFieldModify;
    char pad_1894[0x4];
    particleslib_CPerParticleFloatInput m_flModify;
    particles_ParticleSetMethod_t m_nSetMethod;
    bool m_bUseNeighbor;
    char end_pad_1895[0x3];
};
