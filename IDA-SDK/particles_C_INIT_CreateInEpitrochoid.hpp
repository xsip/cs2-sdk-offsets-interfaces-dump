...
class particles_C_INIT_CreateInEpitrochoid {
    char vTable1797[0x8];
    ...
    particleslib_CPerParticleFloatInput m_flParticleDensity;
    particleslib_CPerParticleFloatInput m_flOffset;
    particleslib_CPerParticleFloatInput m_flRadius1;
    particleslib_CPerParticleFloatInput m_flRadius2;
    bool m_bUseCount;
    bool m_bUseLocalCoords;
    bool m_bOffsetExistingPos;
    char end_pad_1855[0x5];
};
