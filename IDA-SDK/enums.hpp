...
enum animgraphlib_FootstepJumpPhase_t : uint8_t {
...
enum modellib_VertexAlbedoFormat_t : uint8_t {
...
enum soundsystem_lowlevel_VMixGraphCommandID_t : uint32_t {
...
enum particles_ParticleEntityPos_t : uint32_t {
...
enum client_DecalRtEncoding_t : uint8_t {
...
enum client_AnimationAlgorithm_t : uint8_t {
...
enum client_BaseExplosionTypes_t : uint32_t {
...
enum client_EDestructibleParts_DestroyParameterFlags : uint32_t {
...
enum client_ExternalAnimGraphInactiveBehavior_t : uint8_t {
...
enum server_ESceneRequestState_t : uint32_t {
...
enum client_soundlevel_t : uint32_t {
...
enum server_FollowConstraint_t : uint32_t {
