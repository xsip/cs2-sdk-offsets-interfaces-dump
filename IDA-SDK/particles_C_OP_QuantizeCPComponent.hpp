...
class particles_C_OP_QuantizeCPComponent {
    char vTable1797[0x8];
    ...
    particleslib_CParticleCollectionFloatInput m_flInputValue;
    int32_t m_nCPOutput;
    int32_t m_nOutVectorField;
    particleslib_CParticleCollectionFloatInput m_flQuantizeValue;
};
