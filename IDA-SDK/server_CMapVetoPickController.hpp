...
class server_CMapVetoPickController {
    char vTable723[0x8];
    ...
    char pad_3783[0x4];
    char m_OnMapVetoed[0x28];
    char m_OnMapPicked[0x28];
    char m_OnSidesPicked[0x28];
    char m_OnNewPhaseStarted[0x28];
    char m_OnLevelTransition[0x28];
};
