...
class server_CTestPulseIO {
    ...
    char m_OnVariantBool[0x20];
    char m_OnVariantInt[0x20];
    char m_OnVariantFloat[0x20];
    char m_OnVariantString[0x20];
    char m_OnVariantColor[0x20];
    char m_OnVariantVector[0x28];
    bool m_bAllowEmptyInputs;
    char end_pad_4214[0x7];
};
