...
class server_CTestPulseIO {
    ...
    entity2_CEntityIOOutput m_OnVariantVoid;
    entity2_CEntityIOOutput m_OnVariantBool;
    entity2_CEntityIOOutput m_OnVariantInt;
    entity2_CEntityIOOutput m_OnVariantFloat;
    entity2_CEntityIOOutput m_OnVariantString;
    entity2_CEntityIOOutput m_OnVariantColor;
    entity2_CEntityIOOutput m_OnVariantVector;
    bool m_bAllowEmptyInputs;
    char end_pad_4083[0x7];
};
