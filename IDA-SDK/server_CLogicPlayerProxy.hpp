...
class server_CLogicPlayerProxy {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_PlayerHasAmmo;
    entity2_CEntityIOOutput m_PlayerHasNoAmmo;
    entity2_CEntityIOOutput m_PlayerDied;
    char m_RequestedPlayerHealth[0x20];
    char m_hPlayer[0x4];
    char end_pad_3909[0x4];
};
