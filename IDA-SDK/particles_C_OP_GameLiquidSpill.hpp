...
class particles_C_OP_GameLiquidSpill {
    char vTable1797[0x8];
    ...
    particleslib_CParticleCollectionFloatInput m_flLiquidContentsField;
    particleslib_CParticleCollectionFloatInput m_flExpirationTime;
    particles_ParticleAttributeIndex_t m_nAmountAttribute;
    char end_pad_2068[0x4];
};
