...
class server_CTriggerLerpObject {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_OnStartTouch;
    entity2_CEntityIOOutput m_OnStartTouchAll;
    entity2_CEntityIOOutput m_OnEndTouch;
    entity2_CEntityIOOutput m_OnEndTouchAll;
    entity2_CEntityIOOutput m_OnTouching;
    entity2_CEntityIOOutput m_OnTouchingEachEntity;
    entity2_CEntityIOOutput m_OnNotTouching;
    char m_hTouchingEntities[0x18];
    CUtlSymbolLarge m_iFilterName;
    char m_hFilter[0x4];
    bool m_bDisabled;
    char pad_3133[0xb];
    bool m_bUseAsyncQueries;
    char end_pad_3134[0x7];
    CUtlSymbolLarge m_iszLerpTarget;
    char m_hLerpTarget[0x4];
    char pad_4235[0x4];
    CUtlSymbolLarge m_iszLerpTargetAttachment;
    modellib_AttachmentHandle_t m_hLerpTargetAttachment;
    char pad_4236[0x3];
    ...
    char pad_4237[0x5];
    char m_vecLerpingObjects[0x18];
    CUtlSymbolLarge m_iszLerpEffect;
    CUtlSymbolLarge m_iszLerpSound;
    bool m_bAttachTouchingObject;
    char pad_4238[0x3];
    char m_hEntityToWaitForDisconnect[0x4];
    entity2_CEntityIOOutput m_OnLerpStarted;
    entity2_CEntityIOOutput m_OnLerpFinished;
    entity2_CEntityIOOutput m_OnDetached;
};
