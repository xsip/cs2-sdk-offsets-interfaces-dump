...
class particles_C_OP_ConstrainDistanceToPath {
    char vTable1798[0x8];
    ...
    particles_CPathParameters m_PathParameters;
    float32 m_flTravelTime;
    particles_ParticleAttributeIndex_t m_nFieldScale;
    particles_ParticleAttributeIndex_t m_nManualTField;
    char end_pad_2018[0x4];
};
