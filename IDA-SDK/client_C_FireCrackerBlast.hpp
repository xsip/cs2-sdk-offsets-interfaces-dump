...
class client_C_FireCrackerBlast {
    void **__vftable_0;
    ...
    char m_hInfernoClimbingOutlinePointsSnapshot[0x8];
    char m_hInfernoDecalsSnapshot[0x8];
