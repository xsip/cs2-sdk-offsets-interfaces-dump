...
class particles_C_OP_InheritFromParentParticlesV2 {
    char vTable1798[0x8];
    ...
    char pad_2073[0x4];
    particleslib_CPerParticleFloatInput m_nIncrement;
    bool m_bRandomDistribution;
    bool m_bReverse;
    char pad_2074[0x2];
    particles_MissingParentInheritBehavior_t m_nMissingParentBehavior;
