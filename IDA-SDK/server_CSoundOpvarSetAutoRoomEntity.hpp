...
class server_CSoundOpvarSetAutoRoomEntity {
    char vTable723[0x8];
    ...
    char end_pad_4069[0x3];
    entity2_CEntityIOOutput m_OnEnter;
    entity2_CEntityIOOutput m_OnExit;
    bool m_bAutoDisable;
    char pad_4061[0x43];
    ...
    char end_pad_4064[0x4];
    char m_traceResults[0x18];
    char m_doorwayPairs[0x18];
    float32 m_flSize;
    float32 m_flHeightTolerance;
    float32 m_flSizeSqr;
    char end_pad_4070[0x4];
};
