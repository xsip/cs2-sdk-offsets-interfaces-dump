...
class server_CMomentaryRotButton {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_OnIn;
    entity2_CEntityIOOutput m_OnOut;
    int32_t m_nState;
    ...
    entity2_CEntityIOOutput m_OnUnpressed;
    entity2_CEntityIOOutput m_OnFullyOpen;
    entity2_CEntityIOOutput m_OnFullyClosed;
    entity2_CEntityIOOutput m_OnReachedPosition;
    int32_t m_lastUsed;
    QAngle m_start;
    QAngle m_end;
    float32 m_IdealYaw;
