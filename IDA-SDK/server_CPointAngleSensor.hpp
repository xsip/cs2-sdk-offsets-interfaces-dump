...
class server_CPointAngleSensor {
    char vTable723[0x8];
    ...
    char m_hLookAtEntity[0x4];
    float32 m_flDuration;
    float32 m_flDotTolerance;
    entity2_GameTime_t m_flFacingTime;
    bool m_bFired;
    char pad_3898[0x3];
    entity2_CEntityIOOutput m_OnFacingLookat;
    entity2_CEntityIOOutput m_OnNotFacingLookat;
    char m_TargetDir[0x28];
    char m_FacingPercentage[0x28];
};
