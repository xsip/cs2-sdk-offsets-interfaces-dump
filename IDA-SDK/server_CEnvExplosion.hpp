...
class server_CEnvExplosion {
    ...
    client_DamageTypes_t m_iCustomDamageType;
    ...
    char pad_3648[0x3];
    client_Class_T m_iClassIgnore;
    client_Class_T m_iClassIgnore2;
    char pad_3649[0x4];
    CUtlSymbolLarge m_iszEntityIgnoreName;
    char m_hEntityIgnore[0x4];
    char end_pad_3650[0x4];
};
