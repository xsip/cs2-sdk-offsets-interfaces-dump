...
class server_CPlantedC4 {
    ...
    entity2_CEntityIOOutput m_OnBombDefused;
    entity2_CEntityIOOutput m_OnBombBeginDefuse;
    entity2_CEntityIOOutput m_OnBombDefuseAborted;
    ...
    char pad_4017[0x3];
    entity2_GameTime_t m_flNextBotBeepTime;
    char pad_4018[0x4];
    QAngle m_angCatchUpToPlayerEye;
    entity2_GameTime_t m_flLastSpinDetectionTime;
    char end_pad_4019[0x4];
};
