...
class particles_C_OP_ConstrainDistance {
    char vTable1797[0x8];
    ...
    particleslib_CParticleCollectionFloatInput m_fMinDistance;
    particleslib_CParticleCollectionFloatInput m_fMaxDistance;
    int32_t m_nControlPointNumber;
    Vector m_CenterOffset;
    bool m_bGlobalCenter;
    char end_pad_2016[0x7];
};
