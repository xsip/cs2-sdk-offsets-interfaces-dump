...
class particles_C_OP_RenderPostProcessing {
    char vTable1797[0x8];
    ...
    particleslib_CPerParticleFloatInput m_flPostProcessStrength;
    char m_hPostTexture[0x8];
    particles_ParticlePostProcessPriorityGroup_t m_nPriority;
    char end_pad_2231[0x4];
};
