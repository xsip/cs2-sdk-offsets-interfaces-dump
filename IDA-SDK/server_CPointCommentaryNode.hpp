...
class server_CPointCommentaryNode {
    void **__vftable_0;
    ...
    char m_hViewTarget[0x4];
    char m_hViewTargetAngles[0x4];
    CUtlSymbolLarge m_iszViewPosition;
    char m_hViewPosition[0x4];
    char m_hViewPositionMover[0x4];
    bool m_bPreventMovement;
    bool m_bUnderCrosshair;
    bool m_bUnstoppable;
    char pad_4046[0x1];
    entity2_GameTime_t m_flFinishedTime;
    ...
    entity2_GameTime_t m_flAbortedPlaybackAt;
    entity2_CEntityIOOutput m_pOnCommentaryStarted;
    entity2_CEntityIOOutput m_pOnCommentaryStopped;
    bool m_bActive;
    char pad_4048[0x3];
