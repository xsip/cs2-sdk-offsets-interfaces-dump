...
class server_CPropDoorRotatingBreakable {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_OnUnblockedOpening;
    entity2_CEntityIOOutput m_OnFullyClosed;
    entity2_CEntityIOOutput m_OnFullyOpen;
    entity2_CEntityIOOutput m_OnClose;
    entity2_CEntityIOOutput m_OnOpen;
    entity2_CEntityIOOutput m_OnLockedUse;
    entity2_CEntityIOOutput m_OnAjarOpen;
    char end_pad_3123[0x8];
    Vector m_vecAxis;
    float32 m_flDistance;
    server_PropDoorRotatingSpawnPos_t m_eSpawnPosition;
    server_PropDoorRotatingOpenDirection_e m_eOpenDirection;
    server_PropDoorRotatingOpenDirection_e m_eCurrentOpenDirection;
    server_doorCheck_e m_eDefaultCheckDirection;
    ...
    char pad_4082[0x3];
    char m_hEntityBlocker[0x4];
    char end_pad_4083[0x8];
    bool m_bBreakable;
    bool m_isAbleToCloseAreaPortals;
    char pad_4084[0x2];
    int32_t m_currentDamageState;
    char m_damageStates[0x18];
};
