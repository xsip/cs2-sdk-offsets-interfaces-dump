...
class server_CPointAngularVelocitySensor {
    char vTable723[0x8];
    ...
    bool m_bUseHelper;
    char pad_3899[0x3];
    char m_AngularVelocity[0x28];
    entity2_CEntityIOOutput m_OnLessThan;
    entity2_CEntityIOOutput m_OnLessThanOrEqualTo;
    entity2_CEntityIOOutput m_OnGreaterThan;
    entity2_CEntityIOOutput m_OnGreaterThanOrEqualTo;
    entity2_CEntityIOOutput m_OnEqualTo;
};
