...
class server_CFuncShatterglass {
    void **__vftable_0;
    ...
    char m_vecShatterGlassShards[0x18];
    Vector2D m_PanelSize;
    entity2_GameTime_t m_flLastShatterSoundEmitTime;
    entity2_GameTime_t m_flLastCleanupTime;
    entity2_GameTime_t m_flInitAtTime;
    ...
    char m_vInitialDamagePositions[0x18];
    char m_vExtraDamagePositions[0x18];
    char m_vInitialPanelVertices[0x18];
    entity2_CEntityIOOutput m_OnBroken;
    uint8_t m_iSurfaceType;
    char pad_3753[0x7];
    char m_hMaterialDamageBase[0x8];
};
