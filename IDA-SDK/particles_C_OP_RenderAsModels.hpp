...
class particles_C_OP_RenderAsModels {
    char vTable1797[0x8];
    ...
    char pad_2195[0x2];
    particles_ParticleAttributeIndex_t m_nXAxisScalingAttribute;
    particles_ParticleAttributeIndex_t m_nYAxisScalingAttribute;
    particles_ParticleAttributeIndex_t m_nZAxisScalingAttribute;
    int32_t m_nSizeCullBloat;
    char end_pad_2196[0x4];
};
