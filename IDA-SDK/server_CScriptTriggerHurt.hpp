...
class server_CScriptTriggerHurt {
    char vTable723[0x8];
    ...
    entity2_GameTime_t m_flLastDmgTime;
    float32 m_flForgivenessDelay;
    client_DamageTypes_t m_bitsDamageInflict;
    ...
    char pad_4016[0x4];
    entity2_CEntityIOOutput m_OnHurt;
    entity2_CEntityIOOutput m_OnHurtPlayer;
    char m_hurtEntities[0x18];
    Vector m_vExtent;
    char end_pad_4013[0x4];
};
