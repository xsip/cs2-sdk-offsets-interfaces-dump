...
class client_CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_OnPlay;
    float32 m_flRadius;
    char pad_1718[0x4];
