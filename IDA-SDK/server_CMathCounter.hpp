...
class server_CMathCounter {
    ...
    bool m_bDisabled;
    char pad_3790[0x5];
    char m_OutValue[0x28];
    char m_OnGetValue[0x28];
    entity2_CEntityIOOutput m_OnHitMin;
    entity2_CEntityIOOutput m_OnHitMax;
    entity2_CEntityIOOutput m_OnChangedFromMin;
    entity2_CEntityIOOutput m_OnChangedFromMax;
};
