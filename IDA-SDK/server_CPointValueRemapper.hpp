...
class server_CPointValueRemapper {
    char vTable723[0x8];
    ...
    client_ValueRemapperRatchetType_t m_nRatchetType;
    ...
    char pad_3941[0x18];
    char m_Position[0x28];
    char m_PositionDelta[0x28];
    entity2_CEntityIOOutput m_OnReachedValueZero;
    entity2_CEntityIOOutput m_OnReachedValueOne;
    entity2_CEntityIOOutput m_OnReachedValueCustom;
    entity2_CEntityIOOutput m_OnEngage;
    entity2_CEntityIOOutput m_OnDisengage;
};
