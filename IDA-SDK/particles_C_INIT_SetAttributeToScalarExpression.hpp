...
class particles_C_INIT_SetAttributeToScalarExpression {
    char vTable1798[0x8];
    ...
    particles_ScalarExpressionType_t m_nExpression;
    char pad_1971[0x4];
    particleslib_CPerParticleFloatInput m_flInput1;
    particleslib_CPerParticleFloatInput m_flInput2;
    particleslib_CParticleRemapFloatInput m_flOutputRemap;
    particles_ParticleAttributeIndex_t m_nOutputField;
    particles_ParticleSetMethod_t m_nSetMethod;
    char end_pad_1972[0x28];
};
