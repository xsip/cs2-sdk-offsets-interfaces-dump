...
class server_CItemGeneric {
    ...
    void **__vftable_1;
    entity2_CEntityIOOutput m_OnPlayerTouch;
    entity2_CEntityIOOutput m_OnPlayerPickup;
    bool m_bActivateWhenAtRest;
    char pad_3844[0x7];
    entity2_CEntityIOOutput m_OnCacheInteraction;
    entity2_CEntityIOOutput m_OnGlovePulled;
    VectorWS m_vOriginalSpawnOrigin;
    QAngle m_vOriginalSpawnAngles;
    bool m_bPhysStartAsleep;
    char end_pad_3845[0x17];
    void **__vftable_2;
    void **__vftable_3;
    ...
    entity2_GameTime_t m_flLastPickupCheck;
    bool m_bPlayerCounterListenerAdded;
    bool m_bPlayerInTriggerRadius;
    char pad_3850[0x2];
    char m_hSpawnParticleEffect[0x8];
    CUtlSymbolLarge m_pAmbientSoundEffect;
    bool m_bAutoStartAmbientSound;
    char pad_3851[0x7];
    CUtlSymbolLarge m_pSpawnScriptFunction;
    char m_hPickupParticleEffect[0x8];
    CUtlSymbolLarge m_pPickupSoundEffect;
    CUtlSymbolLarge m_pPickupScriptFunction;
    char m_hTimeoutParticleEffect[0x8];
    CUtlSymbolLarge m_pTimeoutSoundEffect;
    CUtlSymbolLarge m_pTimeoutScriptFunction;
    CUtlSymbolLarge m_pPickupFilterName;
    char m_hPickupFilter[0x4];
    char pad_3852[0x4];
    entity2_CEntityIOOutput m_OnPickup;
    entity2_CEntityIOOutput m_OnTimeout;
    entity2_CEntityIOOutput m_OnTriggerStartTouch;
    entity2_CEntityIOOutput m_OnTriggerTouch;
    entity2_CEntityIOOutput m_OnTriggerEndTouch;
    ...
    bool m_bUseable;
    char pad_3853[0x2];
    char m_hTriggerHelper[0x4];
    char end_pad_3854[0xc];
};
