...
class server_CRagdollPropAttached {
    void **__vftable_0;
    ...
    char pad_4110[0x2];
    char m_hDamageEntity[0x4];
    char m_hKiller[0x4];
    char m_hPhysicsAttacker[0x4];
    entity2_GameTime_t m_flLastPhysicsInfluenceTime;
    entity2_GameTime_t m_flFadeOutStartTime;
    float32 m_flFadeTime;
    VectorWS m_vecLastOrigin;
    entity2_GameTime_t m_flAwakeTime;
    entity2_GameTime_t m_flLastOriginChangeTime;
    char pad_4111[0x4];
    ...
    char pad_4113[0x4];
    char m_ragdollMins[0x18];
    char m_ragdollMaxs[0x18];
    bool m_bShouldDeleteActivationRecord;
    char end_pad_4114[0x17];
