...
class server_CLogicAuto {
    ...
    entity2_CEntityIOOutput m_OnMapSpawn;
    entity2_CEntityIOOutput m_OnDemoMapSpawn;
    entity2_CEntityIOOutput m_OnNewGame;
    entity2_CEntityIOOutput m_OnLoadGame;
    entity2_CEntityIOOutput m_OnMapTransition;
    entity2_CEntityIOOutput m_OnBackgroundMap;
    entity2_CEntityIOOutput m_OnMultiNewMap;
    entity2_CEntityIOOutput m_OnMultiNewRound;
    entity2_CEntityIOOutput m_OnVREnabled;
    entity2_CEntityIOOutput m_OnVRNotEnabled;
