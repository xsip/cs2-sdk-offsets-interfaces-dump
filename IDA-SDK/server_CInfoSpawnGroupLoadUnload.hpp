...
class server_CInfoSpawnGroupLoadUnload {
    char vTable723[0x8];
    ...
    entity2_CEntityIOOutput m_OnSpawnGroupLoadStarted;
    entity2_CEntityIOOutput m_OnSpawnGroupLoadFinished;
    entity2_CEntityIOOutput m_OnSpawnGroupUnloadStarted;
    entity2_CEntityIOOutput m_OnSpawnGroupUnloadFinished;
