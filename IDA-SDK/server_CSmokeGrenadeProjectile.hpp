...
class server_CSmokeGrenadeProjectile {
    void **__vftable_0;
    ...
    entity2_CEntityIOOutput m_OnExplode;
    bool m_bHasWarnedAI;
    ...
    char pad_4174[0x4];
    char m_VoxelFrameData[0x18];
    int32_t m_nVoxelFrameDataSize;
    int32_t m_nVoxelUpdate;
    entity2_GameTime_t m_flLastBounce;
    entity2_GameTime_t m_fllastSimulationTime;
    char pad_4175[0x2280];
    bool m_bExplodeFromInferno;
    bool m_bDidGroundScorch;
    char end_pad_4176[0x6];
};
