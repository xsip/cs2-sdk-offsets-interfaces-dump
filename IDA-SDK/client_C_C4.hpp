...
class client_C_C4 {
    ...
    char end_pad_1955[0x1b0];
    client_ParticleIndex_t m_activeLightParticleIndex;
    client_C4LightEffect_t m_eActiveLightEffect;
    bool m_bStartedArming;
    char pad_2026[0x3];
    entity2_GameTime_t m_fArmedTime;
