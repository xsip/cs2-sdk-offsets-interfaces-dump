...
class server_CFuncRotator {
    ...
    entity2_GameTime_t m_flTimeRotationStart;
    char pad_3744[0x4];
    ...
    entity2_CEntityIOOutput m_OnRotationStarted;
    entity2_CEntityIOOutput m_OnRotationCompleted;
    entity2_CEntityIOOutput m_OnOscillate;
    entity2_CEntityIOOutput m_OnOscillateStartArrive;
    entity2_CEntityIOOutput m_OnOscillateStartDepart;
    entity2_CEntityIOOutput m_OnOscillateEndArrive;
    entity2_CEntityIOOutput m_OnOscillateEndDepart;
    bool m_bOscillateDepart;
    char pad_3745[0x3];
    int32_t m_nOscillateCount;
    server_Rotate_t m_eRotateType;
    server_Rotate_t m_ePrevRotateType;
    bool m_bHasTargetOverride;
    char pad_3746[0x7];
    Quaternion m_qOrientationOverride;
    server_RotatorTargetSpace_t m_eSpaceOverride;
