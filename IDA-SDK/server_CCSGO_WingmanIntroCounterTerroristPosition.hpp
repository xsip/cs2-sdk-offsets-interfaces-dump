...
class server_CCSGO_WingmanIntroCounterTerroristPosition {
    char vTable723[0x8];
    ...
    uint64_t m_xuid;
    server_CEconItemView m_agentItem;
    server_CEconItemView m_glovesItem;
    server_CEconItemView m_weaponItem;
};
