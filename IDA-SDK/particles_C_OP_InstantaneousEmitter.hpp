...
class particles_C_OP_InstantaneousEmitter {
    char vTable1798[0x8];
    ...
    char end_pad_1813[0x4];
    particleslib_CParticleCollectionFloatInput m_nParticlesToEmit;
    ...
    particleslib_CParticleCollectionFloatInput m_flParentParticleScale;
