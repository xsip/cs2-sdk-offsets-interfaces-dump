...
class server_CMarkupVolumeTagged_NavGame {
    void **__vftable_0;
    ...
    bool m_bDisabled;
    char end_pad_3918[0x7];
    char m_GroupNames[0x18];
    char m_Tags[0x18];
    bool m_bIsGroup;
    ...
    float32 m_flRefDot;
    server_NavScopeFlags_t m_nScopes;
    bool m_bFloodFillAttribute;
    bool m_bSplitNavSpace;
    char end_pad_3921[0x5];
};
