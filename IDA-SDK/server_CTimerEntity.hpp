...
class server_CTimerEntity {
    ...
    entity2_CEntityIOOutput m_OnTimer;
    entity2_CEntityIOOutput m_OnTimerHigh;
    entity2_CEntityIOOutput m_OnTimerLow;
    int32_t m_iDisabled;
