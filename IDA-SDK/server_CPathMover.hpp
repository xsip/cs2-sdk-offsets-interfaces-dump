...
class server_CPathMover {
    ...
    void **__vftable_1;
    server_CPathQueryComponent m_CPathQueryComponent;
    char pad_3952[0x50];
    CUtlString m_pathString;
    bool m_bClosedLoop;
    char end_pad_3953[0x7];
    char m_vecPathNodes[0x18];
    char pad_3950[0x8];
    CTransform m_xInitialPathWorldToLocal;
    char m_vecMovers[0x18];
    char m_hMoverSpawner[0x4];
    char pad_3948[0x4];
    CUtlSymbolLarge m_iszMoverSpawnerName;
    char end_pad_3949[0x8];
};
