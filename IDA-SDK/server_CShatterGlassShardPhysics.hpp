...
class server_CShatterGlassShardPhysics {
    void **__vftable_0;
    ...
    void **__vftable_2;
    void **__vftable_3;
    entity2_CEntityIOOutput m_MotionEnabled;
    entity2_CEntityIOOutput m_OnAwakened;
    entity2_CEntityIOOutput m_OnAwake;
    entity2_CEntityIOOutput m_OnAsleep;
    entity2_CEntityIOOutput m_OnPlayerUse;
    entity2_CEntityIOOutput m_OnOutOfWorld;
    ...
    char pad_4000[0x2];
    entity2_GameTime_t m_flLastBurn;
    physicslib_DynamicContinuousContactBehavior_t m_nDynamicContinuousContactBehavior;
    char pad_4001[0x3];
    entity2_GameTime_t m_fNextCheckDisableMotionContactsTime;
