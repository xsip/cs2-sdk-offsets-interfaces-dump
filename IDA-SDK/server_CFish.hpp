...
class server_CFish {
    ...
    server_CountdownTimer m_turnTimer;
    bool m_turnClockwise;
    char pad_3701[0x7];
    server_CountdownTimer m_goTimer;
    server_CountdownTimer m_moveTimer;
    server_CountdownTimer m_panicTimer;
    server_CountdownTimer m_disperseTimer;
    server_CountdownTimer m_proximityTimer;
    char m_visible[0x18];
    char end_pad_3702[0x8];
};
