...
class client_CCSGO_WingmanIntroCounterTerroristPosition {
    void **__vftable_0;
    ...
    uint64_t m_xuid;
    client_C_EconItemView m_agentItem;
    client_C_EconItemView m_glovesItem;
    client_C_EconItemView m_weaponItem;
    char end_pad_1583[0x30];
};
