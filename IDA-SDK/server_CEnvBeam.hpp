...
class server_CEnvBeam {
    ...
    entity2_GameTime_t m_flFireTime;
    float32 m_flDamage;
    uint8_t m_nNumBeamEnts;
    char pad_3136[0x7];
    char m_hBaseMaterial[0x8];
    char m_nHaloIndex[0x8];
    client_BeamType_t m_nBeamType;
    uint32_t m_nBeamFlags;
    char m_hAttachEntity[0x4];
    modellib_AttachmentHandle_t m_nAttachIndex[10];
    float32 m_fWidth;
    float32 m_fEndWidth;
    ...
    float32 m_fSpeed;
    float32 m_flFrame;
    client_BeamClipStyle_t m_nClipStyle;
    bool m_bTurnedOff;
    char pad_3137[0x3];
    VectorWS m_vecEndPos;
    char m_hEndEntity[0x4];
    int32_t m_nDissolveType;
    int32_t m_active;
    char pad_3625[0x4];
    char m_spriteTexture[0x8];
    ...
    float32 m_radius;
    server_Touch_t m_TouchType;
    char pad_3627[0x4];
    CUtlSymbolLarge m_iFilterName;
    char m_hFilter[0x4];
    char pad_3628[0x4];
    CUtlSymbolLarge m_iszDecal;
    entity2_CEntityIOOutput m_OnTouchedByEntity;
};
