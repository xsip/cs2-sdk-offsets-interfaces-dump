...
class server_CGamePlayerZone {
    ...
    entity2_CEntityIOOutput m_OnPlayerInZone;
    entity2_CEntityIOOutput m_OnPlayerOutZone;
    char m_PlayersInCount[0x28];
    char m_PlayersOutCount[0x28];
};
