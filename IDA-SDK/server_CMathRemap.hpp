...
class server_CMathRemap {
    ...
    entity2_CEntityIOOutput m_OnRoseAboveMin;
    entity2_CEntityIOOutput m_OnRoseAboveMax;
    entity2_CEntityIOOutput m_OnFellBelowMin;
    entity2_CEntityIOOutput m_OnFellBelowMax;
};
