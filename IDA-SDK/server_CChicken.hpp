...
class server_CChicken {
    ...
    server_CountdownTimer m_updateTimer;
    Vector m_stuckAnchor;
    char pad_3587[0x4];
    server_CountdownTimer m_stuckTimer;
    server_CountdownTimer m_collisionStuckTimer;
    bool m_isOnGround;
    char pad_3588[0x3];
    Vector m_vFallVelocity;
    server_ChickenActivity m_desiredActivity;
    server_ChickenActivity m_currentActivity;
    server_CountdownTimer m_activityTimer;
    float32 m_turnRate;
    char m_fleeFrom[0x4];
    server_CountdownTimer m_moveRateThrottleTimer;
    server_CountdownTimer m_startleTimer;
    server_CountdownTimer m_vocalizeTimer;
    entity2_GameTime_t m_flWhenZombified;
    bool m_jumpedThisFrame;
    char pad_3589[0x3];
    char m_leader[0x4];
    char pad_3590[0x14];
    server_CountdownTimer m_reuseTimer;
    bool m_hasBeenUsed;
    char pad_3591[0x7];
    server_CountdownTimer m_jumpTimer;
    float32 m_flLastJumpTime;
    bool m_bInJump;
    char pad_3592[0x200b];
    server_CountdownTimer m_repathTimer;
    char pad_3593[0x80];
    Vector m_vecPathGoal;
    entity2_GameTime_t m_flActiveFollowStartTime;
    server_CountdownTimer m_followMinuteTimer;
    char pad_3594[0x8];
    server_CountdownTimer m_BlockDirectionTimer;
    char end_pad_3595[0x8];
};
