...
class particles_C_OP_SetFloatCollection {
    char vTable1798[0x8];
    ...
    particleslib_CParticleCollectionFloatInput m_InputValue;
    particles_ParticleAttributeIndex_t m_nOutputField;
    particles_ParticleSetMethod_t m_nSetMethod;
    particleslib_CParticleCollectionFloatInput m_Lerp;
    char end_pad_2315[0x28];
};
