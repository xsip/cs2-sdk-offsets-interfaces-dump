...
class server_CPhysMagnet {
    ...
    entity2_CEntityIOOutput m_OnMagnetAttach;
    entity2_CEntityIOOutput m_OnMagnetDetach;
    float32 m_massScale;
    float32 m_forceLimit;
    float32 m_torqueLimit;
    char pad_3982[0x4];
    char m_MagnettedEntities[0x18];
    bool m_bActive;
    bool m_bHasHitSomething;
    char pad_3983[0x2];
    float32 m_flTotalMass;
    float32 m_flRadius;
    entity2_GameTime_t m_flNextSuckTime;
    int32_t m_iMaxObjectsAttached;
    char end_pad_3984[0x4];
};
