...
class particles_C_OP_BoxConstraint {
    char vTable1797[0x8];
    ...
    particleslib_CParticleCollectionVecInput m_vecMin;
    particleslib_CParticleCollectionVecInput m_vecMax;
    int32_t m_nCP;
    bool m_bLocalSpace;
    bool m_bAccountForRadius;
    char end_pad_1996[0x2];
};
