...
class server_CPhysBox {
    ...
    server_Materials m_Material;
    char m_hBreaker[0x4];
    server_Explosions m_Explosion;
    char pad_3279[0x4];
    ...
    server_EOverrideBlockLOS_t m_nOverrideBlockLOS;
