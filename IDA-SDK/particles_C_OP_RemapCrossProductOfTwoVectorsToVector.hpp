...
class particles_C_OP_RemapCrossProductOfTwoVectorsToVector {
    char vTable1797[0x8];
    ...
    particleslib_CPerParticleVecInput m_InputVec1;
    particleslib_CPerParticleVecInput m_InputVec2;
    particles_ParticleAttributeIndex_t m_nFieldOutput;
    bool m_bNormalize;
    char end_pad_2163[0x3];
};
