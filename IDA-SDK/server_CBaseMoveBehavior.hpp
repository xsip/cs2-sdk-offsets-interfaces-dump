...
class server_CBaseMoveBehavior {
    char vTable723[0x8];
    ...
    char pad_2925[0x4];
    server_CPathKeyFrame* m_pNextKey;
    server_CPathKeyFrame* m_pPrevKey;
    float32 m_flMoveSpeed;
    char end_pad_2926[0xc];
    ...
    char pad_2923[0x4];
    server_CPathKeyFrame* m_pCurrentKeyFrame;
    server_CPathKeyFrame* m_pTargetKeyFrame;
    server_CPathKeyFrame* m_pPreKeyFrame;
    server_CPathKeyFrame* m_pPostKeyFrame;
