...
class server_CVoteController {
    ...
    bool m_bIsYesNoVote;
    char pad_4120[0x7];
    server_CountdownTimer m_acceptingVotesTimer;
    server_CountdownTimer m_executeCommandTimer;
    server_CountdownTimer m_resetVoteTimer;
    int32_t m_nVotesCast[64];
    CPlayerSlot m_playerHoldingVote;
    CPlayerSlot m_playerOverrideForVote;
    int32_t m_nHighestCountIndex;
    char pad_4121[0x4];
    char m_potentialIssues[0x18];
    char m_VoteOptions[0x18];
};
