...
class particles_C_OP_MovementLoopInsideSphere {
    char vTable1797[0x8];
    ...
    int32_t m_nCP;
    char pad_2101[0x4];
    particleslib_CParticleCollectionFloatInput m_flDistance;
    particleslib_CParticleCollectionVecInput m_vecScale;
    particles_ParticleAttributeIndex_t m_nDistSqrAttr;
    char end_pad_2102[0x4];
};
