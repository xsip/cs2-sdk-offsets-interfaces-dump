...
class particles_C_OP_DistanceBetweenVecs {
    char vTable1797[0x8];
    ...
    char pad_2045[0x4];
    particleslib_CPerParticleVecInput m_vecPoint1;
    particleslib_CPerParticleVecInput m_vecPoint2;
