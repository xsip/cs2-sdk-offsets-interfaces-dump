...
class particles_C_OP_SetControlPointFieldToScalarExpression {
    char vTable1797[0x8];
    ...
    char pad_2291[0x4];
    particleslib_CParticleCollectionFloatInput m_flInput1;
    particleslib_CParticleCollectionFloatInput m_flInput2;
