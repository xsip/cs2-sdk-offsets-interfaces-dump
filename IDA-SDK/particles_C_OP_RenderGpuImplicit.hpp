...
class particles_C_OP_RenderGpuImplicit {
    char vTable1797[0x8];
    ...
    char pad_2210[0x4];
    particleslib_CParticleCollectionRendererFloatInput m_fGridSize;
    particleslib_CParticleCollectionRendererFloatInput m_fRadiusScale;
    particleslib_CParticleCollectionRendererFloatInput m_fIsosurfaceThreshold;
    int32_t m_nScaleCP;
    char pad_2211[0x4];
