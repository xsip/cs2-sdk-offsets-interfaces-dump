...
class server_CTriggerLook {
    ...
    entity2_CEntityIOOutput m_OnTrigger;
    char m_hLookTarget[0x4];
    float32 m_flFieldOfView;
    float32 m_flLookTime;
    float32 m_flLookTimeTotal;
    entity2_GameTime_t m_flLookTimeLast;
    ...
    entity2_CEntityIOOutput m_OnStartLook;
    entity2_CEntityIOOutput m_OnEndLook;
};
