...
class particles_C_OP_PerParticleForce {
    char vTable1798[0x8];
    ...
    char pad_1814[0x10];
    particleslib_CPerParticleFloatInput m_flForceScale;
    particleslib_CPerParticleVecInput m_vForce;
    int32_t m_nCP;
    char end_pad_2123[0x4];
};
