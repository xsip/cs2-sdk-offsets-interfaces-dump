...
class particles_C_INIT_SetVectorAttributeToVectorExpression {
    char vTable1797[0x8];
    ...
    particles_VectorExpressionType_t m_nExpression;
    char pad_1978[0x4];
    particleslib_CPerParticleVecInput m_vInput1;
    particleslib_CPerParticleVecInput m_vInput2;
