...
export const particles_C_OP_SetControlPointFieldToScalarExpression  = {
	...
	m_nExpression: 472n, // particles::ScalarExpressionType_t  | Schema_DeclaredEnum | Size: 0x4
	m_flInput1: 480n, // particleslib::CParticleCollectionFloatInput  | Schema_DeclaredClass | Size: 0x170
	m_flInput2: 848n, // particleslib::CParticleCollectionFloatInput  | Schema_DeclaredClass | Size: 0x170
