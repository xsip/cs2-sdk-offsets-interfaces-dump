...
export const animgraphlib_CLeanMatrixUpdateNode  = {
	...
	m_verticalAxis: 200n, // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
	m_horizontalAxis: 212n, // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
	m_hSequence: 224n, // animationsystem::HSequence  | Schema_DeclaredClass | Size: 0x4
	m_flMaxValue: 228n, // float32 m_flMaxValue; |  0xe4 | Schema_Builtin | Size: 0x4
	m_nSequenceMaxFrame: 232n, // int32_t m_nSequenceMaxFrame; |  0xe8 | Schema_Builtin | Size: 0x4
}
