...
export const client_CCSPlayerController_InventoryServices  = {
	...
	m_vecNetworkableLoadout: 64n, // GlobalTypes::CUtlVector<client::CCSPlayerController_InventoryServices_NetworkedLoadoutSlot_t>  | Schema_Atomic | Size: 0x18
	m_unMusicID: 88n, // uint16_t m_unMusicID; |  0x58 | Schema_Builtin | Size: 0x2
	m_rank: 92n, // client::MedalRank_t[6]  | Schema_FixedArray | Size: 0x30
	...
	m_vecServerAuthoritativeWeaponSlots: 136n, // client::C_UtlVectorEmbeddedNetworkVar<client::ServerAuthoritativeWeaponSlot_t>  | Schema_Atomic | Size: 0x68
}
