...
// Class size: 0x78
// BaseClass: NONE
export const client_CDamageRecord  = {
	m_PlayerDamager: 48n, // GlobalTypes::CHandle<client::C_CSPlayerPawn>  | Schema_Atomic | Size: 0x4
	m_PlayerRecipient: 52n, // GlobalTypes::CHandle<client::C_CSPlayerPawn>  | Schema_Atomic | Size: 0x4
	m_hPlayerControllerDamager: 56n, // GlobalTypes::CHandle<client::CCSPlayerController>  | Schema_Atomic | Size: 0x4
	m_hPlayerControllerRecipient: 60n, // GlobalTypes::CHandle<client::CCSPlayerController>  | Schema_Atomic | Size: 0x4
