...
export const server_CEnvWindShared  = {
	...
	m_OnGustStart: 64n, // entity2::CEntityIOOutput  | Schema_DeclaredClass | Size: 0x18
	m_OnGustEnd: 88n, // entity2::CEntityIOOutput  | Schema_DeclaredClass | Size: 0x18
	m_hEntOwner: 112n, // GlobalTypes::CHandle<server::CBaseEntity>  | Schema_Atomic | Size: 0x4
}
